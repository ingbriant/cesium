...
function calculateM(ellipticity, major, latitude) {
  ...
  return (
    major *
    ((1 - e2 / 4 - (3 * e4) / 64 - (5 * e6) / 256 - (175 * e8) / 16384 - (441 * e10) / 65536 - (4851 * e12) / 1048576) *
      phi -
      ((3 * e2) / 8 +
        (3 * e4) / 32 +
        (45 * e6) / 1024 +
        ...
        (6237 * e12) / 524288) *
        sin2Phi +
      ((15 * e4) / 256 + (45 * e6) / 1024 + (525 * e8) / 16384 + (1575 * e10) / 65536 + (155925 * e12) / 8388608) *
        sin4Phi -
...
EllipsoidRhumbLine.prototype.findIntersectionWithLongitude = function (intersectionLongitude, result) {
  ...
  if (Math.abs(CesiumMath.PI_OVER_TWO - absHeading) <= CesiumMath.EPSILON8) {
    ...
    CesiumMath.equalsEpsilon(Math.abs(CesiumMath.PI_OVER_TWO - absHeading), CesiumMath.PI_OVER_TWO, CesiumMath.EPSILON8)
  ) {
