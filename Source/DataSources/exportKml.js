...
function createModel(state, entity, modelGraphics, geometries, styles) {
  ...
  location.appendChild(
    createBasicElementWithText(kmlDoc, "longitude", CesiumMath.toDegrees(scratchCartographic.longitude))
  );
  location.appendChild(
    createBasicElementWithText(kmlDoc, "latitude", CesiumMath.toDegrees(scratchCartographic.latitude))
  );
