...
function GeometryVisualizer(scene, entityCollection, primitives, groundPrimitives) {
  ...
  for (i = 0; i < numberOfShadowModes; ++i) {
    ...
    this._closedColorBatches[numberOfShadowModes + i] = new StaticGeometryColorBatch(
      primitives,
      PerInstanceColorAppearance,
      undefined,
      true,
    ...
    this._closedMaterialBatches[numberOfShadowModes + i] = new StaticGeometryPerMaterialBatch(
      primitives,
      MaterialAppearance,
      undefined,
      true,
    ...
    this._openColorBatches[numberOfShadowModes + i] = new StaticGeometryColorBatch(
      primitives,
      PerInstanceColorAppearance,
      undefined,
      false,
    ...
    this._openMaterialBatches[numberOfShadowModes + i] = new StaticGeometryPerMaterialBatch(
      primitives,
      MaterialAppearance,
      undefined,
      false,
...
GeometryVisualizer.prototype.update = function (time) {
  ...
  for (i = added.length - 1; i > -1; i--) {
    ...
    this._subscriptions.set(
      id,
      updaterSet.geometryChanged.addEventListener(GeometryVisualizer._onGeometryChanged, this)
    );
  }
