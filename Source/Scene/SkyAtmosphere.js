...
SkyAtmosphere.prototype.update = function (frameState) {
  ...
  if (
    useColorCorrect &&
    (!defined(this._spSkyFromSpaceColorCorrect) || !defined(this._spSkyFromAtmosphereColorCorrect))
  ) {
...
function colorCorrect(skyAtmosphere) {
  return !(
    CesiumMath.equalsEpsilon(skyAtmosphere.hueShift, 0.0, CesiumMath.EPSILON7) &&
...
SkyAtmosphere.prototype.destroy = function () {
  ...
  this._spSkyFromAtmosphereColorCorrect =
    this._spSkyFromAtmosphereColorCorrect && this._spSkyFromAtmosphereColorCorrect.destroy();
