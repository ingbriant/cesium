...
Object.defineProperties(Model.prototype, {
  ...
  luminanceAtZenith: {
    ...
    set: function (value) {
      ...
      this._shouldRegenerateShaders =
        this._shouldRegenerateShaders || (defined(lum) && !defined(value)) || (defined(value) && !defined(lum));
  ...
  ForEach.texture(gltf, function (texture, id) {
    ...
    if (defined(bufferViewId)) {
      ...
      promise
        ...
        .otherwise(ModelUtility.getFailedLoadFunction(model, "image", imageResource.url));
    }
  });
}
...
function createProgram(programToCreate, model, context) {
  ...
  if (OctahedralProjectedCubeMap.isSupported(context)) {
    ...
    var usesSM =
      (defined(model._specularEnvironmentMapAtlas) && model._specularEnvironmentMapAtlas.ready) ||
          ...
          for (var j = 0; j < commandsLength; ++j) {
            ...
            if (defined(command) && model._mode === SceneMode.SCENE2D) {
              ...
              command.modelMatrix[13] -=
                CesiumMath.sign(command.modelMatrix[13]) * 2.0 * CesiumMath.PI * projection.ellipsoid.maximumRadius;
              BoundingSphere.transform(primitiveCommand.boundingSphere, command.modelMatrix, command.boundingVolume);
            }
          }
        }
...
Model.prototype.update = function (frameState) {
  ...
  var recompileWithoutDefaultSHCoeffs =
    !defined(frameState.sphericalHarmonicCoefficients) && this._useDefaultSphericalHarmonics;
  ...
  this._useDefaultSpecularMaps =
    !defined(this._specularEnvironmentMapAtlas) && defined(frameState.specularEnvironmentMaps);
  this._useDefaultSphericalHarmonics =
    !defined(this._sphericalHarmonicCoefficients) && defined(frameState.sphericalHarmonicCoefficients);
