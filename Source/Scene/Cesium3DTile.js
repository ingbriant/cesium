...
function getPriorityReverseScreenSpaceError(tileset, tile) {
  ...
  var useParentScreenSpaceError =
    defined(parent) && (!tileset._skipLevelOfDetail || tile._screenSpaceError === 0.0 || parent.hasTilesetContent);
...
function applyDebugSettings(tile, tileset, frameState, passOptions) {
  ...
  var debugColorizeTilesOn =
    (tileset.debugColorizeTiles && !tile._debugColorizeTiles) || defined(tileset._heatmap.tilePropertyName);
