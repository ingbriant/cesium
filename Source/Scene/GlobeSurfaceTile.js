  ...
  eligibleForUnloading: {
    get: function () {
      ...
      var loadingIsTransitioning =
        terrainState === TerrainState.RECEIVING || terrainState === TerrainState.TRANSFORMING;
      ...
      for (var i = 0, len = imagery.length; shouldRemoveTile && i < len; ++i) {
        ...
        shouldRemoveTile =
          !defined(tileImagery.loadingImagery) || tileImagery.loadingImagery.state !== ImageryState.TRANSITIONING;
      }
