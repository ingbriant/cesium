...
function updateTiles(tileset, frameState, passOptions) {
  ...
  var bivariateVisibilityTest =
    tileset._skipLevelOfDetail && tileset._hasMixedContent && frameState.context.stencilBuffer && selectedLength > 0;
...
function raiseLoadProgressEvent(tileset, frameState) {
  ...
  var progressChanged =
    numberOfPendingRequests !== lastNumberOfPendingRequest || numberOfTilesProcessing !== lastNumberOfTilesProcessing;
