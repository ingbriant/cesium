...
describe(
  ...
  function () {
    ...
    function createBufferSpecs(contextOptions) {
      ...
      it(
        "copyFromBuffer throws with one index buffer and the other is not an index buffer" + webglMessage,
        function () {
          if (!context.webgl2) {
            return;
          }
      ...
      it(
        "copyFromBuffer throws when readBuffer is the same buffer and copy range overlaps" + webglMessage,
        function () {
          if (!context.webgl2) {
            return;
          }
