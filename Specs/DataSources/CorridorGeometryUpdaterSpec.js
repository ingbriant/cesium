...
describe(
  ...
  function () {
    ...
    function createBasicCorridor() {
      ...
      corridor.positions = new ConstantProperty(Cartesian3.fromDegreesArray([0, 0, 1, 0, 1, 1, 0, 1]));
    ...
    it("dynamic updater sets properties", function () {
      var corridor = new CorridorGraphics();
      corridor.positions = createDynamicProperty(Cartesian3.fromDegreesArray([0, 0, 1, 0, 1, 1, 0, 1]));
