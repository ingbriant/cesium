...
describe("DataSources/KmlTour", function () {
  function getLookAt() {
    ...
    var hpr = new HeadingPitchRange(CesiumMath.toRadians(10.0), CesiumMath.toRadians(45.0), 10000);
  ...
  function createMockViewer() {
    ...
    mockViewer.scene.camera.flyTo = jasmine.createSpy("flyTo").and.callFake(function (options) {
      if (options.complete) {
        options.complete();
      }
    });
  ...
  it("calls entries play", function () {
    var waitSpy = spyOn(KmlTourWait.prototype, "play").and.callFake(function (callback) {
      callback();
    });
    var flySpy = spyOn(KmlTourFlyTo.prototype, "play").and.callFake(function (callback) {
      callback();
    });
