...
describe("DataSources/SampledPositionProperty", function () {
  ...
  it("getValueInReferenceFrame works without a result parameter", function () {
    ...
    expect(result).toEqual(
      PositionProperty.convertToReferenceFrame(time, value, ReferenceFrame.FIXED, ReferenceFrame.INERTIAL)
    );
  });
  ...
  it("getValueInReferenceFrame works with a result parameter", function () {
    ...
    expect(expected).toEqual(
      PositionProperty.convertToReferenceFrame(time, value, ReferenceFrame.INERTIAL, ReferenceFrame.FIXED)
    );
  });
