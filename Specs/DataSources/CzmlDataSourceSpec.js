...
describe("DataSources/CzmlDataSource", function () {
  ...
  it("clock returns undefined for static CZML", function () {
    return CzmlDataSource.load(makeDocument(staticCzml)).then(function (dataSource) {
      expect(dataSource.clock).toBeUndefined();
    });
  });
  ...
  it("clock returns data interval if no clock defined", function () {
    ...
    return CzmlDataSource.load(makeDocument(dynamicCzml)).then(function (dataSource) {
      var clock = dataSource.clock;
      expect(clock).toBeDefined();
  ...
  it("can load constant data for billboard", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet), {
      ...
      expect(entity.billboard.image.getValue(Iso8601.MINIMUM_VALUE).url).toEqual(sourceUri + packet.billboard.image);
      expect(entity.billboard.rotation.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.billboard.rotation);
      expect(entity.billboard.scale.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.billboard.scale);
      expect(entity.billboard.heightReference.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        HeightReference[packet.billboard.heightReference]
      );
      expect(entity.billboard.horizontalOrigin.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        HorizontalOrigin[packet.billboard.horizontalOrigin]
      );
      expect(entity.billboard.verticalOrigin.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
      ...
      expect(entity.billboard.eyeOffset.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Cartesian3.unpack(packet.billboard.eyeOffset.cartesian)
      );
      expect(entity.billboard.pixelOffset.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Cartesian2.unpack(packet.billboard.pixelOffset.cartesian2)
      );
      expect(entity.billboard.alignedAxis.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Cartesian3.unpack(packet.billboard.alignedAxis.unitCartesian)
      );
      expect(entity.billboard.show.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.billboard.show);
      expect(entity.billboard.sizeInMeters.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.billboard.sizeInMeters);
      expect(entity.billboard.width.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.billboard.width);
      expect(entity.billboard.height.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.billboard.height);
      expect(entity.billboard.scaleByDistance.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        NearFarScalar.unpack(packet.billboard.scaleByDistance.nearFarScalar)
      );
      expect(entity.billboard.translucencyByDistance.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        NearFarScalar.unpack(packet.billboard.translucencyByDistance.nearFarScalar)
      );
      expect(entity.billboard.pixelOffsetScaleByDistance.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        NearFarScalar.unpack(packet.billboard.pixelOffsetScaleByDistance.nearFarScalar)
      );
      expect(entity.billboard.imageSubRegion.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        BoundingRectangle.unpack(packet.billboard.imageSubRegion.boundingRectangle)
      );
    });
  });
  ...
  it("can handle aligned axis expressed as a velocity reference", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(property.getValue(JulianDate.fromIso8601("2016-06-17T12:00:00Z"))).toEqualEpsilon(
        expectedVelocityDirection,
        CesiumMath.EPSILON15
      );
      expect(property.getValue(JulianDate.fromIso8601("2016-06-17T12:00:30Z"))).toEqualEpsilon(
        expectedVelocityDirection,
        CesiumMath.EPSILON15
      );
    });
  ...
  it("can handle aligned axis expressed as a velocity reference within an interval", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(property.getValue(JulianDate.fromIso8601("2016-06-17T12:01:00Z"))).toEqualEpsilon(
        expectedVelocityDirection,
  ...
  it("can load interval data for billboard", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.billboard).toBeDefined();
      expect(entity.billboard.image.getValue(validTime).url).toEqual(packet.billboard.image);
      expect(entity.billboard.scale.getValue(validTime)).toEqual(packet.billboard.scale);
      ...
      expect(entity.billboard.color.getValue(validTime)).toEqual(Color.unpack(packet.billboard.color.rgbaf));
      ...
      expect(entity.billboard.show.getValue(validTime)).toEqual(packet.billboard.show);
  ...
  it("can constrain a constant property by sending an interval in a subsequent packet", function () {
    ...
    return CzmlDataSource.load(makeDocument(constantPacket))
      ...
      .then(function (dataSource) {
        ...
        expect(entity.billboard.scale.getValue(JulianDate.fromIso8601("2009-01-01T00:00:00Z"))).toEqual(
          constantPacket.billboard.scale
        );
        expect(entity.billboard.scale.getValue(JulianDate.fromIso8601("2010-01-01T00:00:00Z"))).toEqual(
          intervalPacket.billboard.scale.number
        );
        expect(entity.billboard.scale.getValue(JulianDate.fromIso8601("2011-01-01T00:00:00Z"))).toEqual(
          constantPacket.billboard.scale
        );
      });
  });
  ...
  it("can constrain a constant position property by sending an interval in a subsequent packet", function () {
    ...
    return CzmlDataSource.load(makeDocument(constantPacket))
      ...
      .then(function (dataSource) {
        ...
        expect(entity.position.getValue(JulianDate.fromIso8601("2009-01-01T00:00:00Z"))).toEqual(
          cartesianFromArrayDegrees(constantPacket.position.cartographicDegrees)
        );
        expect(entity.position.getValue(JulianDate.fromIso8601("2010-01-01T00:00:00Z"))).toEqual(
          cartesianFromArrayDegrees(intervalPacket.position.cartographicDegrees)
        );
        expect(entity.position.getValue(JulianDate.fromIso8601("2011-01-01T00:00:00Z"))).toEqual(
          cartesianFromArrayDegrees(constantPacket.position.cartographicDegrees)
        );
      });
  });
  ...
  it("can convert a sampled property to a composite by sending intervals in a subsequent packet", function () {
    var sampledPacket = {
      ...
      billboard: {
        scale: {
          number: ["2010-01-01T00:00:00Z", 1, "2010-01-01T01:00:00Z", 2, "2010-01-01T02:00:00Z", 3],
        },
      },
    };
  ...
  it("can convert a sampled position property to a composite by sending intervals in a subsequent packet", function () {
    var sampledPacket = {
      id: "a",
      position: {
        cartographicDegrees: ["2010-01-01T00:00:00Z", 34, 117, 10000, "2010-01-01T01:00:00Z", 34, 117, 20000],
      },
    };
    // loading a value with an interval makes the property into a composite.
    var intervalPacket = {
      ...
      position: [
        {
          interval: "2010-01-01T00:20:00Z/2010-01-01T00:22:00Z",
          cartographicDegrees: ["2010-01-01T00:20:00Z", 40, 100, 10000, "2010-01-01T00:22:00Z", 40, 100, 20000],
        },
      ],
    };
    ...
    return CzmlDataSource.load(makeDocument(sampledPacket))
      ...
      .then(function (dataSource) {
        ...
        expect(entity.position).toBeInstanceOf(CompositePositionProperty);
        expect(entity.position.getValue(JulianDate.fromIso8601("2010-01-01T00:00:00Z"))).toEqual(
          Cartesian3.fromDegrees(34, 117, 10000)
        );

        expect(entity.position.getValue(JulianDate.fromIso8601("2010-01-01T00:20:00Z"))).toEqual(
          Cartesian3.fromDegrees(40, 100, 10000)
        );
        expect(entity.position.getValue(JulianDate.fromIso8601("2010-01-01T00:21:00Z"))).toEqualEpsilon(
          Cartesian3.fromDegrees(40, 100, 15000),
          CesiumMath.EPSILON10
        );
        expect(entity.position.getValue(JulianDate.fromIso8601("2010-01-01T00:22:00Z"))).toEqual(
          Cartesian3.fromDegrees(40, 100, 20000)
        );

        expect(entity.position.getValue(JulianDate.fromIso8601("2010-01-01T01:00:00Z"))).toEqual(
          Cartesian3.fromDegrees(34, 117, 20000)
        );
      });
  });
  ...
  it("can handle interval billboard scaleByDistance", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.billboard).toBeDefined();
      expect(entity.billboard.scaleByDistance.getValue(JulianDate.fromIso8601("2013-01-01T00:00:00Z"))).toEqual(
        NearFarScalar.unpack(packet.billboard.scaleByDistance[0].nearFarScalar)
      );
      expect(entity.billboard.scaleByDistance.getValue(JulianDate.fromIso8601("2013-01-01T01:00:00Z"))).toEqual(
        NearFarScalar.unpack(packet.billboard.scaleByDistance[1].nearFarScalar)
      );
    });
  });
  ...
  it("can handle clock data.", function () {
    ...
    return CzmlDataSource.load(documentPacket).then(function (dataSource) {
      ...
      expect(clock.startTime).toEqual(interval.start);
      expect(clock.stopTime).toEqual(interval.stop);
      expect(clock.currentTime).toEqual(JulianDate.fromIso8601(documentPacket.clock.currentTime));
  ...
  it("can load constant data for ellipse", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.ellipse).toBeDefined();
      expect(entity.ellipse.semiMajorAxis.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.ellipse.semiMajorAxis);
      expect(entity.ellipse.semiMinorAxis.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.ellipse.semiMinorAxis);
      expect(entity.ellipse.rotation.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.ellipse.rotation);
      expect(entity.ellipse.outline.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.ellipse.outline);
      expect(entity.ellipse.outlineColor.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Color.unpack(packet.ellipse.outlineColor.rgbaf)
      );
      expect(entity.ellipse.outlineWidth.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.ellipse.outlineWidth);
      expect(entity.ellipse.shadows.getValue(Iso8601.MINIMUM_VALUE)).toEqual(ShadowMode[packet.ellipse.shadows]);
      expect(entity.ellipse.zIndex.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.ellipse.zIndex);
      expect(entity.ellipse.classificationType.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
  ...
  it("can load interval data for ellipse", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.ellipse).toBeDefined();
      expect(entity.ellipse.semiMajorAxis.getValue(validTime)).toEqual(packet.ellipse.semiMajorAxis);
      expect(entity.ellipse.semiMinorAxis.getValue(validTime)).toEqual(packet.ellipse.semiMinorAxis);
      expect(entity.ellipse.rotation.getValue(validTime)).toEqual(packet.ellipse.rotation);
      expect(entity.ellipse.shadows.getValue(validTime)).toEqual(ShadowMode[packet.ellipse.shadows]);
  ...
  it("can load constant data for ellipsoid", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.ellipsoid.show.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.ellipsoid.show);
      expect(entity.ellipsoid.material.getValue(Iso8601.MINIMUM_VALUE).color).toEqual(
        Color.unpack(packet.ellipsoid.material.solidColor.color.rgbaf)
      );
      expect(entity.ellipsoid.outline.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.ellipsoid.outline);
      expect(entity.ellipsoid.outlineColor.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Color.unpack(packet.ellipsoid.outlineColor.rgbaf)
      );
      expect(entity.ellipsoid.outlineWidth.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.ellipsoid.outlineWidth);
      expect(entity.ellipsoid.stackPartitions.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        packet.ellipsoid.stackPartitions
      );
      expect(entity.ellipsoid.slicePartitions.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        packet.ellipsoid.slicePartitions
      );
      expect(entity.ellipsoid.subdivisions.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.ellipsoid.subdivisions);
      expect(entity.ellipsoid.shadows.getValue(Iso8601.MINIMUM_VALUE)).toEqual(ShadowMode[packet.ellipsoid.shadows]);
    });
  });
  ...
  it("can load interval data for ellipsoid", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.ellipsoid).toBeDefined();
      expect(entity.ellipsoid.radii.getValue(validTime)).toEqual(Cartesian3.unpack(packet.ellipsoid.radii.cartesian));
      expect(entity.ellipsoid.show.getValue(validTime)).toEqual(packet.ellipsoid.show);
      expect(entity.ellipsoid.material.getValue(validTime).color).toEqual(
        Color.unpack(packet.ellipsoid.material.solidColor.color.rgbaf)
      );
      expect(entity.ellipsoid.shadows.getValue(validTime)).toEqual(ShadowMode[packet.ellipsoid.shadows]);
  ...
  it("can load constant data for label", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.label.text.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.label.text);
      expect(entity.label.font.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.label.font);
      expect(entity.label.style.getValue(Iso8601.MINIMUM_VALUE)).toEqual(LabelStyle[packet.label.style]);
      ...
      expect(entity.label.outlineWidth.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.label.outlineWidth);
      expect(entity.label.horizontalOrigin.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        HorizontalOrigin[packet.label.horizontalOrigin]
      );
      expect(entity.label.verticalOrigin.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
      ...
      expect(entity.label.scale.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.label.scale);
      expect(entity.label.show.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.label.show);
      expect(entity.label.translucencyByDistance.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        NearFarScalar.unpack(packet.label.translucencyByDistance.nearFarScalar)
      );
      expect(entity.label.pixelOffsetScaleByDistance.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        NearFarScalar.unpack(packet.label.pixelOffsetScaleByDistance.nearFarScalar)
      );
    });
  });
  ...
  it("can load interval data for label", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.label.style.getValue(validTime)).toEqual(LabelStyle[packet.label.style]);
      expect(entity.label.fillColor.getValue(validTime)).toEqual(Color.unpack(packet.label.fillColor.rgbaf));
      expect(entity.label.outlineColor.getValue(validTime)).toEqual(Color.unpack(packet.label.outlineColor.rgbaf));
      expect(entity.label.outlineWidth.getValue(validTime)).toEqual(packet.label.outlineWidth);
      expect(entity.label.horizontalOrigin.getValue(validTime)).toEqual(
        HorizontalOrigin[packet.label.horizontalOrigin]
      );
      expect(entity.label.verticalOrigin.getValue(validTime)).toEqual(VerticalOrigin[packet.label.verticalOrigin]);
      expect(entity.label.eyeOffset.getValue(validTime)).toEqual(Cartesian3.unpack(packet.label.eyeOffset.cartesian));
  ...
  it("can load position", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      var entity = dataSource.entities.values[0];
      expect(entity.position.getValue(Iso8601.MINIMUM_VALUE)).toEqual(Cartesian3.unpack(packet.position.cartesian));
    });
  });
  ...
  it("can load positions expressed as cartographicRadians", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      var entity = dataSource.entities.values[0];
      expect(entity.polyline.positions.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Cartesian3.fromRadiansArrayHeights(packet.polyline.positions.cartographicRadians)
      );
    });
  });
  ...
  it("can load positions expressed as cartographicDegrees", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      var entity = dataSource.entities.values[0];
      expect(entity.polyline.positions.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Cartesian3.fromDegreesArrayHeights(packet.polyline.positions.cartographicDegrees)
      );
    });
  });
  ...
  it("can load viewFrom", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      var entity = dataSource.entities.values[0];
      expect(entity.viewFrom.getValue(Iso8601.MINIMUM_VALUE)).toEqual(Cartesian3.unpack(packet.viewFrom.cartesian));
    });
  });
  ...
  it("can load constant custom properties", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.properties.constant_height.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
  ...
  it("can load custom properties which are constant with specified type", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      var entity = dataSource.entities.values[0];
      expect(entity.properties.constant_name.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
  ...
  it("can load custom properties with one interval", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.properties.changing_name.getValue(JulianDate.fromIso8601("2013"))).toEqual(
        packet.properties.changing_name.value
      );
      expect(entity.properties.changing_name.getValue(JulianDate.fromIso8601("2015"))).toBeUndefined();
    });
  });
  ...
  it("can load custom properties with one interval with specified type", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.properties.changing_name.getValue(JulianDate.fromIso8601("2013"))).toEqual(
        packet.properties.changing_name.string
      );
      expect(entity.properties.changing_name.getValue(JulianDate.fromIso8601("2015"))).toBeUndefined();
    });
  });
  ...
  it("can load custom properties with multiple intervals", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.properties.changing_array.getValue(JulianDate.fromIso8601("2012-06-01"))).toEqual(array1);
      expect(entity.properties.changing_array.getValue(JulianDate.fromIso8601("2013-06-01"))).toEqual(array2);
    });
  });
  ...
  it("can load sampled custom properties", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(
        entity.properties.custom_cartesian.getValue(JulianDate.fromIso8601("2012-04-02T12:00:00Z"))
      ).toBeInstanceOf(Cartesian3);
      expect(entity.properties.custom_cartesian.getValue(JulianDate.fromIso8601("2012-04-02T12:00:00Z"))).toEqual(
        new Cartesian3(1, 2, 3)
      );
      // halfway between two samples, linearly interpolated
      expect(entity.properties.custom_cartesian.getValue(JulianDate.fromIso8601("2012-04-02T12:00:30Z"))).toEqual(
        new Cartesian3((1 + 4) / 2, (2 + 5) / 2, (3 + 6) / 2)
      );
      expect(entity.properties.custom_cartesian.getValue(JulianDate.fromIso8601("2012-04-02T12:01:00Z"))).toEqual(
        new Cartesian3(4, 5, 6)
      );
      expect(entity.properties.custom_cartesian.getValue(JulianDate.fromIso8601("2012-04-02T12:02:00Z"))).toEqual(
  ...
  it("can load various types of custom properties", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.properties.custom_boundingRectangle_constant.getValue(time1)).toEqual(
        BoundingRectangle.unpack(packet.properties.custom_boundingRectangle_constant.boundingRectangle)
      );
      ...
      expect(entity.properties.custom_boundingRectangle_interval.getValue(time1)).toEqual(
        BoundingRectangle.unpack(packet.properties.custom_boundingRectangle_interval[0].boundingRectangle)
      );
      expect(entity.properties.custom_boundingRectangle_interval.getValue(time2)).toEqual(
        BoundingRectangle.unpack(packet.properties.custom_boundingRectangle_interval[1].boundingRectangle)
      );
      ...
      expect(entity.properties.custom_boundingRectangle_sampled.getValue(time1)).toEqual(
        BoundingRectangle.unpack(packet.properties.custom_boundingRectangle_sampled.boundingRectangle, 0 + 1)
      );
      expect(
        entity.properties.custom_boundingRectangle_sampled.getValue(JulianDate.addSeconds(time1, 60, new JulianDate()))
      ).toEqual(BoundingRectangle.unpack(packet.properties.custom_boundingRectangle_sampled.boundingRectangle, 4 + 2));
      ...
      expect(entity.properties.custom_cartesian2_constant.getValue(time1)).toEqual(
        Cartesian2.unpack(packet.properties.custom_cartesian2_constant.cartesian2)
      );
      ...
      expect(entity.properties.custom_cartesian2_interval.getValue(time1)).toEqual(
        Cartesian2.unpack(packet.properties.custom_cartesian2_interval[0].cartesian2)
      );
      expect(entity.properties.custom_cartesian2_interval.getValue(time2)).toEqual(
        Cartesian2.unpack(packet.properties.custom_cartesian2_interval[1].cartesian2)
      );
      ...
      expect(entity.properties.custom_cartesian2_sampled.getValue(time1)).toEqual(
        Cartesian2.unpack(packet.properties.custom_cartesian2_sampled.cartesian2, 0 + 1)
      );
      expect(
        entity.properties.custom_cartesian2_sampled.getValue(JulianDate.addSeconds(time1, 60, new JulianDate()))
      ).toEqual(Cartesian2.unpack(packet.properties.custom_cartesian2_sampled.cartesian2, 2 + 2));
      ...
      expect(entity.properties.custom_cartesian_constant.getValue(time1)).toEqual(
      ...
      expect(entity.properties.custom_cartesian_interval.getValue(time1)).toEqual(
        Cartesian3.unpack(packet.properties.custom_cartesian_interval[0].cartesian)
      );
      expect(entity.properties.custom_cartesian_interval.getValue(time2)).toEqual(
        Cartesian3.unpack(packet.properties.custom_cartesian_interval[1].cartesian)
      );
      ...
      expect(entity.properties.custom_cartesian_sampled.getValue(time1)).toEqual(
        Cartesian3.unpack(packet.properties.custom_cartesian_sampled.cartesian, 0 + 1)
      );
      expect(
        entity.properties.custom_cartesian_sampled.getValue(JulianDate.addSeconds(time1, 60, new JulianDate()))
      ).toEqual(Cartesian3.unpack(packet.properties.custom_cartesian_sampled.cartesian, 3 + 2));
      ...
      expect(
        entity.properties.custom_color_sampled.getValue(JulianDate.addSeconds(time1, 60, new JulianDate()))
      ).toEqual(Color.unpack(packet.properties.custom_color_sampled.rgbaf, 4 + 2));
  ...
  it("can delete samples from a sampled property", function () {
    var packet = {
      ...
      billboard: {
        scale: {
          number: ["2012-03-15T10:00:00Z", 1, "2012-03-15T11:00:00Z", 5, "2012-03-15T12:00:00Z", 3],
        },
      },
    };
  ...
  it("can delete samples from a sampled position property", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet))
      .then(function (dataSource) {
        ...
        expect(entity.position.getValue(JulianDate.fromIso8601("2016-06-17T12:00:00Z"))).toEqual(
          new Cartesian3(1, 2, 3)
        );
        expect(entity.position.getValue(JulianDate.fromIso8601("2016-06-17T12:01:00Z"))).toEqual(
          new Cartesian3(61, 122, 183)
        );
        expect(entity.position.getValue(JulianDate.fromIso8601("2016-06-17T12:02:00Z"))).toEqual(
  ...
  it("can delete interval from an interval position property", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet))
      .then(function (dataSource) {
        ...
        expect(entity.position.getValue(JulianDate.fromIso8601("2013-01-01T00:30:00Z"))).toEqual(
          new Cartesian3(1, 2, 3)
        );
        expect(entity.position.getValue(JulianDate.fromIso8601("2013-01-01T01:30:00Z"))).toEqual(
          new Cartesian3(4, 5, 6)
        );
      ...
      .then(function (dataSource) {
        ...
        expect(entity.position.getValue(JulianDate.fromIso8601("2013-01-01T00:29:00Z"))).toEqual(
          new Cartesian3(1, 2, 3)
        );
        expect(entity.position.getValue(JulianDate.fromIso8601("2013-01-01T01:31:00Z"))).toEqual(
          new Cartesian3(4, 5, 6)
        );
      });
  });
    ...
    var packet = {
      ...
      billboard: {
        scale: [
          ...
          {
            interval: "2013-01-01T01:00:00Z/2013-01-01T02:00:00Z",
            number: ["2013-01-01T01:00:00Z", 9, "2013-01-01T01:00:30Z", 19, "2013-01-01T01:01:00Z", 11],
          },
        ],
      },
    };
  ...
  it("can delete samples from a composite position property", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet))
      .then(function (dataSource) {
        ...
        expect(entity.position.getValue(JulianDate.fromIso8601("2013-01-01T00:00:00Z"))).toEqual(
          new Cartesian3(1, 2, 3)
        );
        expect(entity.position.getValue(JulianDate.fromIso8601("2013-01-01T00:00:30Z"))).toEqual(
          new Cartesian3(6, 7, 8)
        );
        expect(entity.position.getValue(JulianDate.fromIso8601("2013-01-01T00:01:00Z"))).toEqual(
          new Cartesian3(3, 4, 5)
        );
        expect(entity.position.getValue(JulianDate.fromIso8601("2013-01-01T00:02:00Z"))).toEqual(
          new Cartesian3(15, 16, 17)
        );
        expect(entity.position.getValue(JulianDate.fromIso8601("2013-01-01T01:00:00Z"))).toEqual(
          new Cartesian3(9, 15, 10)
        );
        expect(entity.position.getValue(JulianDate.fromIso8601("2013-01-01T01:00:30Z"))).toEqual(
          new Cartesian3(19, 16, 11)
        );
        expect(entity.position.getValue(JulianDate.fromIso8601("2013-01-01T01:01:00Z"))).toEqual(
          new Cartesian3(11, 17, 12)
        );
  ...
  it("can load constant data for path", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.path.material.color.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Color.unpack(packet.path.material.polylineOutline.color.rgbaf)
      );
      expect(entity.path.material.outlineColor.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Color.unpack(packet.path.material.polylineOutline.outlineColor.rgbaf)
      );
      expect(entity.path.material.outlineWidth.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        packet.path.material.polylineOutline.outlineWidth
      );
      expect(entity.path.width.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.path.width);
      expect(entity.path.resolution.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.path.resolution);
      expect(entity.path.leadTime.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.path.leadTime);
      expect(entity.path.trailTime.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.path.trailTime);
      expect(entity.path.show.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.path.show);
    });
  });
  ...
  it("can load interval data for path", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.path.resolution.getValue(validTime)).toEqual(packet.path.resolution);
      expect(entity.path.leadTime.getValue(validTime)).toEqual(packet.path.leadTime);
      expect(entity.path.trailTime.getValue(validTime)).toEqual(packet.path.trailTime);
  ...
  it("can load constant data for point", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.point.color.getValue(Iso8601.MINIMUM_VALUE)).toEqual(Color.unpack(packet.point.color.rgbaf));
      expect(entity.point.pixelSize.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.point.pixelSize);
      expect(entity.point.outlineColor.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Color.unpack(packet.point.outlineColor.rgbaf)
      );
      expect(entity.point.outlineWidth.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.point.outlineWidth);
      expect(entity.point.show.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.point.show);
      expect(entity.point.scaleByDistance.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        NearFarScalar.unpack(packet.point.scaleByDistance.nearFarScalar)
      );
      expect(entity.point.translucencyByDistance.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        NearFarScalar.unpack(packet.point.translucencyByDistance.nearFarScalar)
      );
      expect(entity.point.heightReference.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
  ...
  it("can load interval data for point", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.point).toBeDefined();
      expect(entity.point.color.getValue(validTime)).toEqual(Color.unpack(packet.point.color.rgbaf));
      expect(entity.point.pixelSize.getValue(validTime)).toEqual(packet.point.pixelSize);
      expect(entity.point.outlineColor.getValue(validTime)).toEqual(Color.unpack(packet.point.outlineColor.rgbaf));
      expect(entity.point.outlineWidth.getValue(validTime)).toEqual(packet.point.outlineWidth);
  ...
  it("can load constant data for polygon", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.polygon.material.getValue(Iso8601.MINIMUM_VALUE).color).toEqual(
        Color.unpack(packet.polygon.material.solidColor.color.rgbaf)
      );
      expect(entity.polygon.show.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polygon.show);
      expect(entity.polygon.height.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polygon.height);
      expect(entity.polygon.extrudedHeight.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polygon.extrudedHeight);
      expect(entity.polygon.granularity.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polygon.granularity);
      expect(entity.polygon.stRotation.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polygon.stRotation);
      expect(entity.polygon.outline.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polygon.outline);
      expect(entity.polygon.outlineColor.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Color.unpack(packet.polygon.outlineColor.rgbaf)
      );
      expect(entity.polygon.outlineWidth.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polygon.outlineWidth);
      expect(entity.polygon.closeTop.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polygon.closeTop);
      expect(entity.polygon.closeBottom.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polygon.closeBottom);
      expect(entity.polygon.shadows.getValue(Iso8601.MINIMUM_VALUE)).toEqual(ShadowMode[packet.polygon.shadows]);
      expect(entity.polygon.zIndex.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polygon.zIndex);
      expect(entity.polygon.classificationType.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
  ...
  it("can load interval data for polygon", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.polygon.show.getValue(validTime)).toEqual(packet.polygon.show);
      expect(entity.polygon.shadows.getValue(validTime)).toEqual(ShadowMode[packet.polygon.shadows]);
  ...
  it("can load constant polygon positions", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(hierarchy.positions).toEqual(
        Cartesian3.fromDegreesArrayHeights(packet.polygon.positions.cartographicDegrees)
      );
  ...
  it("can load constant polygon positions with holes", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(hierarchy.holes).toEqual(
        packet.polygon.holes.cartographicDegrees.map(unpackPolygonHoleFromCartographicDegrees)
      );
    });
  });
  ...
  it("can load interval polygon positions", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(hierarchy).toBeInstanceOf(PolygonHierarchy);
      expect(hierarchy.positions).toEqual(
        Cartesian3.fromDegreesArrayHeights(packet.polygon.positions[0].cartographicDegrees)
      );

      hierarchy = entity.polygon.hierarchy.getValue(JulianDate.fromIso8601("2012-08-04T16:20:00Z"));
      expect(hierarchy).toBeInstanceOf(PolygonHierarchy);
      expect(hierarchy.positions).toEqual(
        Cartesian3.fromDegreesArrayHeights(packet.polygon.positions[1].cartographicDegrees)
      );
    });
  });
  ...
  it("can load interval polygon positions with holes expressed as degrees", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(hierarchy.holes).toEqual(
        packet.polygon.holes[0].cartographicDegrees.map(unpackPolygonHoleFromCartographicDegrees)
      );
      ...
      expect(hierarchy.holes).toEqual(
        packet.polygon.holes[1].cartographicDegrees.map(unpackPolygonHoleFromCartographicDegrees)
      );
    });
  });
  ...
  it("can load interval polygon positions with holes expressed as radians", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(hierarchy).toBeInstanceOf(PolygonHierarchy);
      expect(hierarchy.positions).toEqual(
        Cartesian3.fromRadiansArrayHeights(packet.polygon.positions[0].cartographicRadians)
      );
      expect(hierarchy.holes).toEqual(
        packet.polygon.holes[0].cartographicRadians.map(unpackPolygonHoleFromCartographicRadians)
      );
    });
  });
  ...
  it("can load reference polygon positions with holes", function () {
    var packets = [
      ...
      },
      {
        ...
        polygon: {
          positions: {
            references: ["target1#position", "target2#position", "target3#position"],
          },
          holes: {
            references: [["target4#position", "target5#position", "target6#position"]],
          },
        },
      },
    ];
  ...
  it("can load constant data for polyline", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.polyline.material.color.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Color.unpack(packet.polyline.material.polylineOutline.color.rgbaf)
      );
      expect(entity.polyline.material.outlineColor.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Color.unpack(packet.polyline.material.polylineOutline.outlineColor.rgbaf)
      );
      expect(entity.polyline.material.outlineWidth.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        packet.polyline.material.polylineOutline.outlineWidth
      );
      expect(entity.polyline.width.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polyline.width);
      expect(entity.polyline.show.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polyline.show);
      expect(entity.polyline.shadows.getValue(Iso8601.MINIMUM_VALUE)).toEqual(ShadowMode[packet.polyline.shadows]);
      expect(entity.polyline.classificationType.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
  ...
  it("can load interval data for polyline", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.polyline.width.getValue(validTime)).toEqual(packet.polyline.width);
      expect(entity.polyline.show.getValue(validTime)).toEqual(packet.polyline.show);
      expect(entity.polyline.shadows.getValue(validTime)).toEqual(ShadowMode[packet.polyline.shadows]);
  ...
  it("can load constant data for polyline clamped to terrain.", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.polyline.width.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polyline.width);
      expect(entity.polyline.show.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polyline.show);
      expect(entity.polyline.clampToGround.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polyline.clampToGround);
      expect(entity.polyline.zIndex.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.polyline.zIndex);
    });
  });
  ...
  it("can load constant data for model", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.model.show.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.model.show);
      expect(entity.model.scale.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.model.scale);
      expect(entity.model.minimumPixelSize.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.model.minimumPixelSize);
      expect(entity.model.maximumScale.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.model.maximumScale);
      expect(entity.model.uri.getValue(Iso8601.MINIMUM_VALUE).url).toEqual(packet.model.gltf);
      expect(entity.model.incrementallyLoadTextures.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        packet.model.incrementallyLoadTextures
      );
      expect(entity.model.shadows.getValue(Iso8601.MINIMUM_VALUE)).toEqual(ShadowMode[packet.model.shadows]);
      expect(entity.model.heightReference.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        HeightReference[packet.model.heightReference]
      );
      expect(entity.model.silhouetteColor.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Color.unpack(packet.model.silhouetteColor.rgbaf)
      );
      expect(entity.model.silhouetteSize.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.model.silhouetteSize);
      expect(entity.model.color.getValue(Iso8601.MINIMUM_VALUE)).toEqual(Color.unpack(packet.model.color.rgbaf));
      expect(entity.model.colorBlendMode.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        ColorBlendMode[packet.model.colorBlendMode]
      );
      expect(entity.model.colorBlendAmount.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.model.colorBlendAmount);

      var nodeTransform = entity.model.nodeTransformations.getValue(Iso8601.MINIMUM_VALUE).Mesh;
      expect(nodeTransform).toBeDefined();
      expect(nodeTransform.scale).toEqual(Cartesian3.unpack(packet.model.nodeTransformations.Mesh.scale.cartesian));
      expect(nodeTransform.translation).toEqual(
        Cartesian3.unpack(packet.model.nodeTransformations.Mesh.translation.cartesian)
      );

      var expectedRotation = Quaternion.unpack(packet.model.nodeTransformations.Mesh.rotation.unitQuaternion);
      Quaternion.normalize(expectedRotation, expectedRotation);
      expect(nodeTransform.rotation).toEqual(expectedRotation);

      expect(entity.model.nodeTransformations.Mesh.scale.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Cartesian3.unpack(packet.model.nodeTransformations.Mesh.scale.cartesian)
      );
      expect(entity.model.nodeTransformations.Mesh.translation.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Cartesian3.unpack(packet.model.nodeTransformations.Mesh.translation.cartesian)
      );
      ...
      expect(articulations["SampleArticulation Yaw"]).toEqual(packet.model.articulations["SampleArticulation Yaw"]);
      expect(articulations["SampleArticulation Pitch"]).toEqual(packet.model.articulations["SampleArticulation Pitch"]);
      expect(articulations["SampleArticulation Roll"]).toEqual(packet.model.articulations["SampleArticulation Roll"]);
    });
  });
  ...
  it("can load interval data for model", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.model.minimumPixelSize.getValue(validTime)).toEqual(packet.model.minimumPixelSize);
      expect(entity.model.uri.getValue(validTime).url).toEqual(packet.model.gltf);
      expect(entity.model.incrementallyLoadTextures.getValue(validTime)).toEqual(
        packet.model.incrementallyLoadTextures
      );
      expect(entity.model.shadows.getValue(validTime)).toEqual(ShadowMode[packet.model.shadows]);
      expect(entity.model.heightReference.getValue(validTime)).toEqual(HeightReference[packet.model.heightReference]);
      expect(entity.model.silhouetteColor.getValue(validTime)).toEqual(
        Color.unpack(packet.model.silhouetteColor.rgbaf)
      );
      expect(entity.model.silhouetteSize.getValue(validTime)).toEqual(packet.model.silhouetteSize);
      expect(entity.model.color.getValue(validTime)).toEqual(Color.unpack(packet.model.color.rgbaf));
      expect(entity.model.colorBlendMode.getValue(validTime)).toEqual(ColorBlendMode[packet.model.colorBlendMode]);
      expect(entity.model.colorBlendAmount.getValue(validTime)).toEqual(packet.model.colorBlendAmount);
      ...
      expect(entity.model.nodeTransformations.Mesh.scale.getValue(validTime)).toEqual(
        Cartesian3.unpack(packet.model.nodeTransformations.Mesh.scale.cartesian)
      );
      expect(entity.model.nodeTransformations.Mesh.translation.getValue(validTime)).toEqual(
        Cartesian3.unpack(packet.model.nodeTransformations.Mesh.translation.cartesian)
      );
  ...
  it("can load node transformations expressed as intervals", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(nodeTransform.translation).toEqual(
        Cartesian3.unpack(packet.model.nodeTransformations[0].Mesh.translation.cartesian)
      );
      ...
      expect(nodeTransform.translation).toEqual(
        Cartesian3.unpack(packet.model.nodeTransformations[1].Mesh.translation.cartesian)
      );
    ...
    return CzmlDataSource.load(makeDocument(packet))
      .then(function (dataSource) {
        ...
        expect(entity.polygon.material.getValue(solidTime).color).toEqual(
          Color.unpack(packet.polygon.material[0].solidColor.color.rgba.map(Color.byteToFloat))
        );

        function assertValuesForGridMaterial(time) {
          expect(entity.polygon.material.getValue(time).color).toEqual(
            Color.unpack(packet.polygon.material[1].grid.color.rgba.map(Color.byteToFloat))
          );
          ...
          expect(entity.polygon.material.getValue(time).lineCount).toEqual(
            Cartesian2.unpack(packet.polygon.material[1].grid.lineCount.cartesian2)
          );
          expect(entity.polygon.material.getValue(time).lineThickness).toEqual(
            Cartesian2.unpack(packet.polygon.material[1].grid.lineThickness.cartesian2)
          );
          expect(entity.polygon.material.getValue(time).lineOffset).toEqual(
            Cartesian2.unpack(packet.polygon.material[1].grid.lineOffset.cartesian2)
          );
        }
      ...
      .then(function (dataSource) {
        ...
        expect(entity.polygon.material.getType(solidTime)).toEqual("Color");
        expect(entity.polygon.material.getValue(solidTime).color).toEqual(
          Color.unpack(secondPacket.polygon.material[0].solidColor.color.rgba.map(Color.byteToFloat))
        );
      });
  });
  ...
  it("can load constant data for rectangle", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.rectangle.coordinates.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Rectangle.unpack(packet.rectangle.coordinates.wsen)
      );
      expect(entity.rectangle.material.getValue(Iso8601.MINIMUM_VALUE).color).toEqual(
        Color.unpack(packet.rectangle.material.solidColor.color.rgbaf)
      );
      expect(entity.rectangle.show.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.rectangle.show);
      expect(entity.rectangle.height.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.rectangle.height);
      expect(entity.rectangle.extrudedHeight.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.rectangle.extrudedHeight);
      expect(entity.rectangle.granularity.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.rectangle.granularity);
      expect(entity.rectangle.rotation.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.rectangle.rotation);
      expect(entity.rectangle.stRotation.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.rectangle.stRotation);
      expect(entity.rectangle.outline.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.rectangle.outline);
      expect(entity.rectangle.outlineColor.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Color.unpack(packet.rectangle.outlineColor.rgbaf)
      );
      expect(entity.rectangle.outlineWidth.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.rectangle.outlineWidth);
      expect(entity.rectangle.shadows.getValue(Iso8601.MINIMUM_VALUE)).toEqual(ShadowMode[packet.rectangle.shadows]);
      expect(entity.rectangle.zIndex.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.rectangle.zIndex);
      expect(entity.rectangle.classificationType.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
  ...
  it("can load constant data for wall", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.wall.material.getValue(Iso8601.MINIMUM_VALUE).color).toEqual(
        Color.unpack(packet.wall.material.solidColor.color.rgbaf)
      );
      expect(entity.wall.show.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.wall.show);
      expect(entity.wall.granularity.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.wall.granularity);
      expect(entity.wall.minimumHeights.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.wall.minimumHeights.array);
      expect(entity.wall.maximumHeights.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.wall.maximumHeights.array);
      expect(entity.wall.outline.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.wall.outline);
      expect(entity.wall.outlineColor.getValue(Iso8601.MINIMUM_VALUE)).toEqual(new Color(0.2, 0.2, 0.2, 0.2));
      expect(entity.wall.outlineWidth.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.wall.outlineWidth);
      expect(entity.wall.shadows.getValue(Iso8601.MINIMUM_VALUE)).toEqual(ShadowMode[packet.wall.shadows]);
    });
  });
  ...
  it("can load data for wall with minimumHeights as references.", function () {
    ...
    return CzmlDataSource.load(packets).then(function (dataSource) {
      ...
      expect(entity.wall).toBeDefined();
      expect(entity.wall.minimumHeights.getValue(Iso8601.MINIMUM_VALUE)).toEqual([
        packets[1].billboard.scale,
        packets[2].billboard.scale,
      ]);
      expect(entity.wall.maximumHeights.getValue(Iso8601.MINIMUM_VALUE)).toEqual([
        packets[2].billboard.scale,
        packets[1].billboard.scale,
      ]);
    });
  ...
  it("can load array of references expressed using intervals", function () {
    ...
    return CzmlDataSource.load(packets).then(function (dataSource) {
      ...
      expect(entity.wall.minimumHeights.getValue(JulianDate.fromIso8601("2010-01-01T00:00:00Z"))).toEqual([
        packets[1].billboard.scale,
        packets[2].billboard.scale,
      ]);
      expect(entity.wall.minimumHeights.getValue(JulianDate.fromIso8601("2010-01-01T01:00:00Z"))).toEqual([
        packets[2].billboard.scale,
        packets[3].billboard.scale,
      ]);
    });
  });
  ...
  it("can load constant data for box", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.box.show.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.box.show);
      expect(entity.box.outline.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.box.outline);
      expect(entity.box.outlineColor.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Color.unpack(packet.box.outlineColor.rgbaf)
      );
      expect(entity.box.outlineWidth.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.box.outlineWidth);
      expect(entity.box.shadows.getValue(Iso8601.MINIMUM_VALUE)).toEqual(ShadowMode[packet.box.shadows]);
    });
  });
  ...
  it("can load constant data for cylinder", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.cylinder.length.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.cylinder.length);
      expect(entity.cylinder.topRadius.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.cylinder.topRadius);
      expect(entity.cylinder.bottomRadius.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.cylinder.bottomRadius);
      expect(entity.cylinder.material.getValue(Iso8601.MINIMUM_VALUE).color).toEqual(
        Color.unpack(packet.cylinder.material.solidColor.color.rgbaf)
      );
      expect(entity.cylinder.show.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.cylinder.show);
      expect(entity.cylinder.outline.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.cylinder.outline);
      expect(entity.cylinder.outlineColor.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Color.unpack(packet.cylinder.outlineColor.rgbaf)
      );
      expect(entity.cylinder.outlineWidth.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.cylinder.outlineWidth);
      expect(entity.cylinder.numberOfVerticalLines.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        packet.cylinder.numberOfVerticalLines
      );
      expect(entity.cylinder.slices.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.cylinder.slices);
      expect(entity.cylinder.shadows.getValue(Iso8601.MINIMUM_VALUE)).toEqual(ShadowMode[packet.cylinder.shadows]);
    });
  });
  ...
  it("can load constant data for corridor", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.corridor.material.getValue(Iso8601.MINIMUM_VALUE).color).toEqual(
        Color.unpack(packet.corridor.material.solidColor.color.rgbaf)
      );
      expect(entity.corridor.show.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.corridor.show);
      expect(entity.corridor.height.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.corridor.height);
      expect(entity.corridor.width.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.corridor.width);
      expect(entity.corridor.cornerType.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        CornerType[packet.corridor.cornerType]
      );
      expect(entity.corridor.extrudedHeight.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.corridor.extrudedHeight);
      expect(entity.corridor.granularity.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.corridor.granularity);
      expect(entity.corridor.outline.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.corridor.outline);
      expect(entity.corridor.outlineColor.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
        Color.unpack(packet.corridor.outlineColor.rgbaf)
      );
      expect(entity.corridor.outlineWidth.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.corridor.outlineWidth);
      expect(entity.corridor.shadows.getValue(Iso8601.MINIMUM_VALUE)).toEqual(ShadowMode[packet.corridor.shadows]);
      expect(entity.corridor.zIndex.getValue(Iso8601.MINIMUM_VALUE)).toEqual(packet.corridor.zIndex);
      expect(entity.corridor.classificationType.getValue(Iso8601.MINIMUM_VALUE)).toEqual(
  ...
  it("can load a polyline with polyline glow material", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.polyline.material.glowPower.getValue()).toEqual(packet.polyline.material.polylineGlow.glowPower);
      expect(entity.polyline.material.taperPower.getValue()).toEqual(packet.polyline.material.polylineGlow.taperPower);
    });
  });
  ...
  it("can load a polyline with polyline dash material", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(entity.polyline.material.dashLength.getValue()).toEqual(packet.polyline.material.polylineDash.dashLength);
  ...
  it("loads extrapolation options", function () {
    ...
    return CzmlDataSource.load(makeDocument(packet)).then(function (dataSource) {
      ...
      expect(color.forwardExtrapolationType).toEqual(ExtrapolationType[packet.point.color.forwardExtrapolationType]);
      expect(color.forwardExtrapolationDuration).toEqual(packet.point.color.forwardExtrapolationDuration);
      expect(color.backwardExtrapolationType).toEqual(ExtrapolationType[packet.point.color.backwardExtrapolationType]);
      expect(color.backwardExtrapolationDuration).toEqual(packet.point.color.backwardExtrapolationDuration);

      var position = entity.position;
      expect(position.forwardExtrapolationType).toEqual(ExtrapolationType[packet.position.forwardExtrapolationType]);
      expect(position.forwardExtrapolationDuration).toEqual(packet.position.forwardExtrapolationDuration);
      expect(position.backwardExtrapolationType).toEqual(ExtrapolationType[packet.position.backwardExtrapolationType]);
      expect(position.backwardExtrapolationDuration).toEqual(packet.position.backwardExtrapolationDuration);
    });
  });
  ...
  it("converts followSurface to arcType for backwards compatibility", function () {
    ...
    return CzmlDataSource.load(packets).then(function (dataSource) {
      ...
      expect(entity.polyline.arcType.getValue(JulianDate.fromIso8601("2013-01-01T00:00:00Z"))).toEqual(
        ArcType.GEODESIC
      );
      expect(entity.polyline.arcType.getValue(JulianDate.fromIso8601("2013-01-01T01:00:00Z"))).toEqual(ArcType.NONE);
  ...
  it("checks validation document", function () {
    return CzmlDataSource.load("Data/CZML/ValidationDocument.czml").then(function (dataSource) {
      ...
      expect(e.orientation.getValue(date)).toEqualEpsilon(
        new Quaternion(0.431493311977589, 0.560811914509339, 0.423522822587574, 0.565625261998114),
        1e-14
      );
      ...
      expect(e.billboard.alignedAxis.getValue(date)).toEqualEpsilon(
        new Cartesian3(0.205062091895724, 0.975768213485699, 0.0763277932228903),
        1e-14
      );
      ...
      expect(e.model.nodeTransformations.prop.rotation.getValue(date)).toEqualEpsilon(
        new Quaternion(0.527960606328925, 0.567156704919186, 0.624812964569899, 0.0959146992664751),
        1e-14
      );
      ...
      expect(e.rectangle.coordinates.getValue(date)).toEqual(
        new Rectangle(1.13325368272577, 0.703573207377445, 0.756676249095309, 0.339217858685931)
      );
      ...
      expect(e.billboard.color.getValue(date)).toEqualEpsilon(
        new Color(0.674509803921569, 0.866666666666667, 0.6, 0.650980392156863),
        1e-14
      );
      ...
      expect(e.box.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.996078431372549, 0.0823529411764706, 0.494117647058824, 0.101960784313725),
        1e-14
      );
      ...
      expect(e.box.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.733333333333333, 0.474509803921569, 0.56078431372549, 0.349019607843137),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_box_material_grid_color"))).toBeDefined();
      expect(e.box.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.847058823529412, 0.392156862745098, 0.352941176470588, 0.898039215686275),
        1e-14
      );
      ...
      expect(e.box.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.666666666666667, 0.976470588235294, 0.83921568627451, 0.643137254901961),
        1e-14
      );
      ...
      expect(e.box.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.258823529411765, 0.796078431372549, 0.717647058823529, 0.749019607843137),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_box_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.box.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.741176470588235, 0.0941176470588235, 0.101960784313725, 0.509803921568627),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_box_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.box.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.403921568627451, 0.768627450980392, 0.717647058823529, 0.0392156862745098),
        1e-14
      );
      ...
      expect(e.box.outlineColor.getValue(date)).toEqualEpsilon(
        new Color(0.835294117647059, 0.0313725490196078, 0.282352941176471, 0.337254901960784),
        1e-14
      );
      ...
      expect(e.corridor.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.333333333333333, 0.87843137254902, 0.356862745098039, 0.435294117647059),
        1e-14
      );
      ...
      expect(e.corridor.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.0156862745098039, 0.0941176470588235, 0.4, 0.529411764705882),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_corridor_material_grid_color"))).toBeDefined();
      expect(e.corridor.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.576470588235294, 0.76078431372549, 0.152941176470588, 0.00392156862745098),
        1e-14
      );
      ...
      expect(e.corridor.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.913725490196078, 0.63921568627451, 0.631372549019608, 0.890196078431372),
        1e-14
      );
      ...
      expect(e.corridor.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.2, 0.137254901960784, 0.792156862745098, 0.301960784313725),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_corridor_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.corridor.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.286274509803922, 0.619607843137255, 0.615686274509804, 0.231372549019608),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_corridor_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.corridor.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.690196078431373, 0.172549019607843, 0.984313725490196, 0.43921568627451),
        1e-14
      );
      ...
      expect(e.corridor.outlineColor.getValue(date)).toEqualEpsilon(
        new Color(0.690196078431373, 0.0549019607843137, 0.247058823529412, 0.298039215686275),
        1e-14
      );
      ...
      expect(e.cylinder.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.47843137254902, 0.0509803921568627, 0.450980392156863, 0.87843137254902),
        1e-14
      );
      ...
      expect(e.cylinder.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.654901960784314, 0.0627450980392157, 0.517647058823529, 0.537254901960784),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_cylinder_material_grid_color"))).toBeDefined();
      expect(e.cylinder.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.901960784313726, 0.364705882352941, 0.305882352941176, 0.945098039215686),
        1e-14
      );
      ...
      expect(e.cylinder.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.0901960784313725, 0.133333333333333, 0.372549019607843, 0.498039215686275),
        1e-14
      );
      ...
      expect(e.cylinder.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.905882352941176, 0.564705882352941, 0.486274509803922, 0.67843137254902),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_cylinder_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.cylinder.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.513725490196078, 0.756862745098039, 0.764705882352941, 0.882352941176471),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_cylinder_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.cylinder.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.450980392156863, 0.392156862745098, 0.333333333333333, 0.537254901960784),
        1e-14
      );
      ...
      expect(e.cylinder.outlineColor.getValue(date)).toEqualEpsilon(
        new Color(0.647058823529412, 0.564705882352941, 0.4, 0.0862745098039216),
        1e-14
      );
      ...
      expect(e.ellipse.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.0980392156862745, 0.913725490196078, 0.811764705882353, 0.2),
        1e-14
      );
      ...
      expect(e.ellipse.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.364705882352941, 0.698039215686274, 0.803921568627451, 0.843137254901961),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_ellipse_material_grid_color"))).toBeDefined();
      expect(e.ellipse.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.67843137254902, 0.580392156862745, 0.823529411764706, 0.627450980392157),
        1e-14
      );
      ...
      expect(e.ellipse.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.313725490196078, 0.768627450980392, 0.674509803921569, 0.705882352941177),
        1e-14
      );
      ...
      expect(e.ellipse.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.682352941176471, 0.658823529411765, 0.952941176470588, 0.0823529411764706),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_ellipse_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.ellipse.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.0196078431372549, 0.537254901960784, 0.290196078431373, 0.403921568627451),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_ellipse_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.ellipse.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.317647058823529, 0.690196078431373, 0.223529411764706, 0.886274509803922),
        1e-14
      );
      ...
      expect(e.ellipse.outlineColor.getValue(date)).toEqualEpsilon(
        new Color(0.572549019607843, 0.956862745098039, 0.968627450980392, 0.674509803921569),
        1e-14
      );
      ...
      expect(e.ellipsoid.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.572549019607843, 0.533333333333333, 0.384313725490196, 0.2),
        1e-14
      );
      ...
      expect(e.ellipsoid.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.247058823529412, 0.403921568627451, 0.145098039215686, 0.47843137254902),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_ellipsoid_material_grid_color"))).toBeDefined();
      expect(e.ellipsoid.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.270588235294118, 0.784313725490196, 0.172549019607843, 0.835294117647059),
        1e-14
      );
      ...
      expect(e.ellipsoid.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.415686274509804, 0.192156862745098, 0.368627450980392, 0.129411764705882),
        1e-14
      );
      ...
      expect(e.ellipsoid.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.580392156862745, 0.164705882352941, 0.741176470588235, 0.0941176470588235),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_ellipsoid_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.ellipsoid.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.137254901960784, 0.784313725490196, 0.294117647058824, 0.964705882352941),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_ellipsoid_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.ellipsoid.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.905882352941176, 0.929411764705882, 0.427450980392157, 0.113725490196078),
        1e-14
      );
      ...
      expect(e.ellipsoid.outlineColor.getValue(date)).toEqualEpsilon(
        new Color(0.494117647058824, 0.0823529411764706, 0.274509803921569, 0.823529411764706),
        1e-14
      );
      ...
      expect(e.label.backgroundColor.getValue(date)).toEqualEpsilon(
        new Color(0.894117647058824, 0.949019607843137, 0.494117647058824, 0.843137254901961),
        1e-14
      );
      ...
      expect(e.label.fillColor.getValue(date)).toEqualEpsilon(
        new Color(0.16078431372549, 0.568627450980392, 0.776470588235294, 0.505882352941176),
        1e-14
      );
      ...
      expect(e.label.outlineColor.getValue(date)).toEqualEpsilon(
        new Color(0.458823529411765, 0.325490196078431, 0.909803921568627, 0.67843137254902),
        1e-14
      );
      ...
      expect(e.model.silhouetteColor.getValue(date)).toEqualEpsilon(
        new Color(0.294117647058824, 0.313725490196078, 0.419607843137255, 0.87843137254902),
        1e-14
      );
      ...
      expect(e.model.color.getValue(date)).toEqualEpsilon(
        new Color(0.568627450980392, 0.333333333333333, 0.141176470588235, 0.572549019607843),
        1e-14
      );
      ...
      expect(e.path.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.458823529411765, 0.517647058823529, 0.52156862745098, 0.925490196078431),
        1e-14
      );
      ...
      expect(e.path.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.0588235294117647, 0.0823529411764706, 0.964705882352941, 0.317647058823529),
        1e-14
      );
      ...
      expect(e.path.material.outlineColor.getValue(date)).toEqualEpsilon(
        new Color(0.266666666666667, 0.556862745098039, 0.352941176470588, 0.76078431372549),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_path_material_polylineArrow_color"))).toBeDefined();
      expect(e.path.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.627450980392157, 0.27843137254902, 0.972549019607843, 0.92156862745098),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_path_material_polylineDash_color"))).toBeDefined();
      expect(e.path.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.113725490196078, 0.368627450980392, 0.411764705882353, 0.745098039215686),
        1e-14
      );
      ...
      expect(e.path.material.gapColor.getValue(date)).toEqualEpsilon(
        new Color(0.831372549019608, 0.313725490196078, 0.341176470588235, 0.749019607843137),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_path_material_polylineGlow_color"))).toBeDefined();
      expect(e.path.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.584313725490196, 0.0156862745098039, 0.329411764705882, 0.270588235294118),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_path_material_image_color"))).toBeDefined();
      expect(e.path.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.443137254901961, 0.450980392156863, 0.63921568627451, 0.415686274509804),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_path_material_grid_color"))).toBeDefined();
      expect(e.path.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.984313725490196, 0.945098039215686, 0.764705882352941, 0.933333333333333),
        1e-14
      );
      ...
      expect(e.path.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.584313725490196, 0.631372549019608, 0.0196078431372549, 0.349019607843137),
        1e-14
      );
      ...
      expect(e.path.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.231372549019608, 0.211764705882353, 0.941176470588235, 0.501960784313725),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_path_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.path.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.258823529411765, 0.850980392156863, 0.196078431372549, 0.811764705882353),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_path_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.path.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.0745098039215686, 0.933333333333333, 0.184313725490196, 0.117647058823529),
        1e-14
      );
      ...
      expect(e.point.color.getValue(date)).toEqualEpsilon(
        new Color(0.662745098039216, 0.317647058823529, 0.643137254901961, 0.705882352941177),
        1e-14
      );
      ...
      expect(e.point.outlineColor.getValue(date)).toEqualEpsilon(
        new Color(0.00392156862745098, 0.388235294117647, 0.101960784313725, 0.16078431372549),
        1e-14
      );
      ...
      expect(e.polygon.hierarchy.getValue(date).holes).toEqual([
        new PolygonHierarchy([
          ...
          Cartesian3.fromRadians(0.0636782022426772, 0.558333087028927, 32510),
        ]),
        new PolygonHierarchy([
          Cartesian3.fromRadians(1.50366253893541, 0.779166543514464, 33810),
          Cartesian3.fromRadians(1.42489853818289, 0.00358717805196918, 20389),
      ...
      expect(e.polygon.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.980392156862745, 0.905882352941176, 0.274509803921569, 0.972549019607843),
        1e-14
      );
      ...
      expect(e.polygon.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.674509803921569, 0.8, 0.411764705882353, 0.207843137254902),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polygon_material_grid_color"))).toBeDefined();
      expect(e.polygon.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.603921568627451, 0.0941176470588235, 0.00784313725490196, 0.0862745098039216),
        1e-14
      );
      ...
      expect(e.polygon.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.772549019607843, 0.866666666666667, 0.964705882352941, 0.862745098039216),
        1e-14
      );
      ...
      expect(e.polygon.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.862745098039216, 0.0392156862745098, 0.458823529411765, 0.596078431372549),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polygon_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.polygon.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.396078431372549, 0.576470588235294, 0.474509803921569, 0.909803921568627),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polygon_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.polygon.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.117647058823529, 0.258823529411765, 0.541176470588235, 0.207843137254902),
        1e-14
      );
      ...
      expect(e.polygon.outlineColor.getValue(date)).toEqualEpsilon(
        new Color(0.105882352941176, 0.423529411764706, 0.619607843137255, 0.956862745098039),
        1e-14
      );
      ...
      expect(e.polyline.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.764705882352941, 0.894117647058824, 0.874509803921569, 0.105882352941176),
        1e-14
      );
      ...
      expect(e.polyline.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.450980392156863, 0.890196078431372, 0.403921568627451, 0.16078431372549),
        1e-14
      );
      expect(
        (e = dataSource.entities.getById("constant_polyline_material_polylineOutline_outlineColor"))
      ).toBeDefined();
      expect(e.polyline.material.outlineColor.getValue(date)).toEqualEpsilon(
        new Color(0.815686274509804, 0.545098039215686, 0.529411764705882, 0.317647058823529),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polyline_material_polylineArrow_color"))).toBeDefined();
      expect(e.polyline.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.831372549019608, 0.823529411764706, 0.631372549019608, 0.443137254901961),
        1e-14
      );
      ...
      expect(e.polyline.material.gapColor.getValue(date)).toEqualEpsilon(
        new Color(0.0509803921568627, 0.0313725490196078, 0.23921568627451, 0.4),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polyline_material_polylineGlow_color"))).toBeDefined();
      expect(e.polyline.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.411764705882353, 0.313725490196078, 0.858823529411765, 0.380392156862745),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polyline_material_image_color"))).toBeDefined();
      expect(e.polyline.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.133333333333333, 0.552941176470588, 0.0431372549019608, 0.184313725490196),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polyline_material_grid_color"))).toBeDefined();
      expect(e.polyline.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.141176470588235, 0.823529411764706, 0.588235294117647, 0.56078431372549),
        1e-14
      );
      ...
      expect(e.polyline.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.647058823529412, 0.862745098039216, 0.129411764705882, 0.780392156862745),
        1e-14
      );
      ...
      expect(e.polyline.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.290196078431373, 0.780392156862745, 0.0705882352941176, 0.27843137254902),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polyline_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.polyline.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.505882352941176, 0.466666666666667, 0.862745098039216, 0.803921568627451),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polyline_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.polyline.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.32156862745098, 0.454901960784314, 0.803921568627451, 0.203921568627451),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polyline_depthFailMaterial_solidColor_color"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(date)).toEqualEpsilon(
        new Color(0.905882352941176, 0.635294117647059, 0.435294117647059, 0.631372549019608),
        1e-14
      );
      ...
      expect(
        (e = dataSource.entities.getById("constant_polyline_depthFailMaterial_polylineOutline_color"))
      ).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(date)).toEqualEpsilon(
        new Color(0.976470588235294, 0.133333333333333, 0.835294117647059, 0.694117647058824),
        1e-14
      );
      expect(
        (e = dataSource.entities.getById("constant_polyline_depthFailMaterial_polylineOutline_outlineColor"))
      ).toBeDefined();
      expect(e.polyline.depthFailMaterial.outlineColor.getValue(date)).toEqualEpsilon(
        new Color(0.8, 0.866666666666667, 0.219607843137255, 0.262745098039216),
        1e-14
      );
      expect(
        (e = dataSource.entities.getById("constant_polyline_depthFailMaterial_polylineArrow_color"))
      ).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(date)).toEqualEpsilon(
        new Color(0.0392156862745098, 0.988235294117647, 0.784313725490196, 0.211764705882353),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polyline_depthFailMaterial_polylineDash_color"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(date)).toEqualEpsilon(
        new Color(0.0431372549019608, 0.235294117647059, 0.443137254901961, 0.701960784313725),
        1e-14
      );
      expect(
        (e = dataSource.entities.getById("constant_polyline_depthFailMaterial_polylineDash_gapColor"))
      ).toBeDefined();
      expect(e.polyline.depthFailMaterial.gapColor.getValue(date)).toEqualEpsilon(
        new Color(0.388235294117647, 0.0196078431372549, 0.780392156862745, 0.941176470588235),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polyline_depthFailMaterial_polylineGlow_color"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(date)).toEqualEpsilon(
        new Color(0.733333333333333, 0.180392156862745, 0.407843137254902, 0.168627450980392),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polyline_depthFailMaterial_image_color"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(date)).toEqualEpsilon(
        new Color(0.815686274509804, 0.47843137254902, 0.254901960784314, 0.47843137254902),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polyline_depthFailMaterial_grid_color"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(date)).toEqualEpsilon(
        new Color(0.247058823529412, 0.945098039215686, 0.0274509803921569, 0.968627450980392),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polyline_depthFailMaterial_stripe_evenColor"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.517647058823529, 0.576470588235294, 0.615686274509804, 0.682352941176471),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_polyline_depthFailMaterial_stripe_oddColor"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.333333333333333, 0.537254901960784, 0.443137254901961, 0.658823529411765),
        1e-14
      );
      expect(
        (e = dataSource.entities.getById("constant_polyline_depthFailMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(e.polyline.depthFailMaterial.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.145098039215686, 0.815686274509804, 0.113725490196078, 0.729411764705882),
        1e-14
      );
      expect(
        (e = dataSource.entities.getById("constant_polyline_depthFailMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(e.polyline.depthFailMaterial.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.0941176470588235, 0.615686274509804, 0.447058823529412, 0.00392156862745098),
        1e-14
      );
      ...
      expect(e.rectangle.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.898039215686275, 0.8, 0.905882352941176, 0.952941176470588),
        1e-14
      );
      ...
      expect(e.rectangle.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.247058823529412, 0.498039215686275, 0.741176470588235, 0.968627450980392),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_rectangle_material_grid_color"))).toBeDefined();
      expect(e.rectangle.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.458823529411765, 0.0627450980392157, 0.886274509803922, 0.83921568627451),
        1e-14
      );
      ...
      expect(e.rectangle.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.576470588235294, 0.341176470588235, 0.611764705882353, 0.207843137254902),
        1e-14
      );
      ...
      expect(e.rectangle.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.866666666666667, 0.949019607843137, 0.0627450980392157, 0.0196078431372549),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_rectangle_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.rectangle.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.545098039215686, 0.647058823529412, 0.603921568627451, 0.725490196078431),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_rectangle_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.rectangle.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.227450980392157, 0.164705882352941, 0.619607843137255, 0.905882352941176),
        1e-14
      );
      ...
      expect(e.rectangle.outlineColor.getValue(date)).toEqualEpsilon(
        new Color(0.301960784313725, 0.0352941176470588, 0.917647058823529, 0.207843137254902),
        1e-14
      );
      ...
      expect(e.wall.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.694117647058824, 0.317647058823529, 0.909803921568627, 0.501960784313725),
        1e-14
      );
      ...
      expect(e.wall.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.349019607843137, 0.843137254901961, 0.290196078431373, 0.0431372549019608),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_wall_material_grid_color"))).toBeDefined();
      expect(e.wall.material.color.getValue(date)).toEqualEpsilon(
        new Color(0.756862745098039, 0.992156862745098, 0.992156862745098, 0.462745098039216),
        1e-14
      );
      ...
      expect(e.wall.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.690196078431373, 0.211764705882353, 0.615686274509804, 0.627450980392157),
        1e-14
      );
      ...
      expect(e.wall.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.968627450980392, 0.368627450980392, 0.219607843137255, 0.00392156862745098),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_wall_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.wall.material.evenColor.getValue(date)).toEqualEpsilon(
        new Color(0.376470588235294, 0.396078431372549, 0.698039215686274, 0.545098039215686),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_wall_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.wall.material.oddColor.getValue(date)).toEqualEpsilon(
        new Color(0.396078431372549, 0.0196078431372549, 0.27843137254902, 0.525490196078431),
        1e-14
      );
      ...
      expect(e.wall.outlineColor.getValue(date)).toEqualEpsilon(
        new Color(0.564705882352941, 0.67843137254902, 0.764705882352941, 0.811764705882353),
        1e-14
      );
      expect((e = dataSource.entities.getById("constant_agi_conicSensor_intersectionColor_rgbaf"))).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_lateralSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("material_conicSensor_lateralSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_lateralSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect((e = dataSource.entities.getById("constant_conicSensor_lateralSurfaceMaterial_grid_color"))).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_lateralSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_lateralSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_lateralSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_lateralSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_ellipsoidSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("material_conicSensor_ellipsoidSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_ellipsoidSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_ellipsoidSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_ellipsoidSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_ellipsoidSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_ellipsoidSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_ellipsoidSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_ellipsoidHorizonSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_conicSensor_ellipsoidHorizonSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_conicSensor_ellipsoidHorizonSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_conicSensor_ellipsoidHorizonSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_conicSensor_ellipsoidHorizonSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_ellipsoidHorizonSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_ellipsoidHorizonSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_ellipsoidHorizonSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_ellipsoidHorizonSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_ellipsoidHorizonSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_ellipsoidHorizonSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_domeSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_domeSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_domeSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_domeSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_domeSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_environmentOcclusionMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_conicSensor_environmentOcclusionMaterial_image"))
      ).toBeDefined();
      expect((e = dataSource.entities.getById("material_conicSensor_environmentOcclusionMaterial_grid"))).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_conicSensor_environmentOcclusionMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_conicSensor_environmentOcclusionMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_environmentOcclusionMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_environmentOcclusionMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_environmentOcclusionMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_environmentOcclusionMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_environmentOcclusionMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_conicSensor_environmentOcclusionMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_agi_conicSensor_environmentIntersectionColor_rgbaf"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_agi_customPatternSensor_directions_unitSpherical"))
      ).toBeDefined();
      expect((e = dataSource.entities.getById("constant_agi_customPatternSensor_directions_cartesian"))).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_agi_customPatternSensor_directions_unitCartesian"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_agi_customPatternSensor_intersectionColor_rgbaf"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_lateralSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_lateralSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_lateralSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_lateralSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_lateralSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_lateralSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_lateralSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_lateralSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_lateralSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_lateralSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_lateralSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_ellipsoidSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_ellipsoidSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_ellipsoidSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_ellipsoidSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_ellipsoidSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_ellipsoidSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_ellipsoidSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_ellipsoidSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_ellipsoidSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
      ...
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_ellipsoidSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById(
      ...
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_ellipsoidHorizonSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_ellipsoidHorizonSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_ellipsoidHorizonSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_ellipsoidHorizonSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_ellipsoidHorizonSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_ellipsoidHorizonSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById(
      ...
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_domeSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_domeSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_domeSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_domeSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_domeSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_domeSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_domeSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_domeSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_domeSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_environmentOcclusionMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_environmentOcclusionMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_environmentOcclusionMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_environmentOcclusionMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_customPatternSensor_environmentOcclusionMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_environmentOcclusionMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_environmentOcclusionMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_environmentOcclusionMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_customPatternSensor_environmentOcclusionMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById(
      ...
      expect(
        (e = dataSource.entities.getById("constant_agi_customPatternSensor_environmentIntersectionColor_rgbaf"))
      ).toBeDefined();
      expect((e = dataSource.entities.getById("constant_agi_rectangularSensor_intersectionColor_rgbaf"))).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_lateralSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_lateralSurfaceMaterial_image"))
      ).toBeDefined();
      expect((e = dataSource.entities.getById("material_rectangularSensor_lateralSurfaceMaterial_grid"))).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_lateralSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_lateralSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_lateralSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_lateralSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_lateralSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_lateralSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_lateralSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_lateralSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_ellipsoidSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_ellipsoidSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_ellipsoidSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_ellipsoidSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_ellipsoidSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_ellipsoidSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_ellipsoidSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_ellipsoidSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_ellipsoidSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_ellipsoidSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_ellipsoidSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_ellipsoidHorizonSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_ellipsoidHorizonSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_ellipsoidHorizonSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_ellipsoidHorizonSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_ellipsoidHorizonSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_ellipsoidHorizonSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_ellipsoidHorizonSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_ellipsoidHorizonSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_ellipsoidHorizonSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById(
      ...
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_domeSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_domeSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_domeSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_domeSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_domeSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_domeSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_domeSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_domeSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_environmentOcclusionMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_environmentOcclusionMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_environmentOcclusionMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_environmentOcclusionMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("material_rectangularSensor_environmentOcclusionMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_environmentOcclusionMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_environmentOcclusionMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_environmentOcclusionMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("constant_rectangularSensor_environmentOcclusionMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById(
      ...
      expect(
        (e = dataSource.entities.getById("constant_agi_rectangularSensor_environmentIntersectionColor_rgbaf"))
      ).toBeDefined();
      ...
      expect(e.properties.custom_unitCartesian.getValue(date)).toEqualEpsilon(
        new Cartesian3(0.77935070007851, 0.565493818550955, 0.269868907930861),
        1e-14
      );
      ...
      expect(e.properties.custom_rgbaf.getValue(date)).toEqualEpsilon(
        new Color(0.0666666666666667, 0.0666666666666667, 0.231372549019608, 0.427450980392157),
        1e-14
      );
      ...
      expect(e.properties.custom_unitQuaternion.getValue(date)).toEqualEpsilon(
        new Quaternion(0.742737937277143, 0.267679401430615, 0.507905263014791, 0.344558178514049),
        1e-14
      );
      ...
      expect(e.properties.custom_wsen.getValue(date)).toEqual(
        new Rectangle(1.47520917005826, 1.17615981869183, 0.973692387723505, 1.00039738410474)
      );
      ...
      expect(e.corridor.positions.getValue(date)).toEqual([
        dataSource.entities.getById("ConstantPosition1").position.getValue(date),
        dataSource.entities.getById("ConstantPosition2").position.getValue(date),
      ]);
      ...
      expect(e.model.nodeTransformations.referenceProp.translation.getValue(date)).toEqual(
        constant.model.nodeTransformations.prop.translation.getValue(date)
      );
      expect(e.model.nodeTransformations.referenceProp.rotation.getValue(date)).toEqual(
        constant.model.nodeTransformations.prop.rotation.getValue(date)
      );
      expect(e.model.nodeTransformations.referenceProp.scale.getValue(date)).toEqual(
        constant.model.nodeTransformations.prop.scale.getValue(date)
      );
      ...
      expect(e.polygon.hierarchy.getValue(date).holes).toEqual([
        new PolygonHierarchy([
          dataSource.entities.getById("ConstantPosition1").position.getValue(date),
          dataSource.entities.getById("ConstantPosition2").position.getValue(date),
          dataSource.entities.getById("ConstantPosition3").position.getValue(date),
        ]),
      ]);
      ...
      expect(e.wall.minimumHeights.getValue(date)).toEqual([
        dataSource.entities.getById("ConstantDouble1").billboard.scale.getValue(date),
        dataSource.entities.getById("ConstantDouble2").billboard.scale.getValue(date),
      ]);
      ...
      expect(e.box.material.image.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_image").box.material.image.getValue(date)
      );
      expect(e.box.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_image").box.material.repeat.getValue(date)
      );
      expect(e.box.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_image").box.material.color.getValue(date)
      );
      expect(e.box.material.transparent.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_image").box.material.transparent.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_box_material_grid"))).toBeDefined();
      expect(e.box.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_grid").box.material.color.getValue(date)
      );
      expect(e.box.material.cellAlpha.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_grid").box.material.cellAlpha.getValue(date)
      );
      expect(e.box.material.lineCount.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_grid").box.material.lineCount.getValue(date)
      );
      expect(e.box.material.lineThickness.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_grid").box.material.lineThickness.getValue(date)
      );
      expect(e.box.material.lineOffset.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_grid").box.material.lineOffset.getValue(date)
      );
      ...
      expect(e.box.material.orientation.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_stripe").box.material.orientation.getValue(date)
      );
      expect(e.box.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_stripe").box.material.evenColor.getValue(date)
      );
      expect(e.box.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_stripe").box.material.oddColor.getValue(date)
      );
      expect(e.box.material.offset.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_stripe").box.material.offset.getValue(date)
      );
      expect(e.box.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_stripe").box.material.repeat.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_box_material_checkerboard"))).toBeDefined();
      expect(e.box.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_checkerboard").box.material.evenColor.getValue(date)
      );
      expect(e.box.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_checkerboard").box.material.oddColor.getValue(date)
      );
      expect(e.box.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_box_material_checkerboard").box.material.repeat.getValue(date)
      );
      ...
      expect(e.corridor.material.image.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_image").corridor.material.image.getValue(date)
      );
      expect(e.corridor.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_image").corridor.material.repeat.getValue(date)
      );
      expect(e.corridor.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_image").corridor.material.color.getValue(date)
      );
      expect(e.corridor.material.transparent.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_image").corridor.material.transparent.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_corridor_material_grid"))).toBeDefined();
      expect(e.corridor.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_grid").corridor.material.color.getValue(date)
      );
      expect(e.corridor.material.cellAlpha.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_grid").corridor.material.cellAlpha.getValue(date)
      );
      expect(e.corridor.material.lineCount.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_grid").corridor.material.lineCount.getValue(date)
      );
      expect(e.corridor.material.lineThickness.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_grid").corridor.material.lineThickness.getValue(date)
      );
      expect(e.corridor.material.lineOffset.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_grid").corridor.material.lineOffset.getValue(date)
      );
      ...
      expect(e.corridor.material.orientation.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_stripe").corridor.material.orientation.getValue(date)
      );
      expect(e.corridor.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_stripe").corridor.material.evenColor.getValue(date)
      );
      expect(e.corridor.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_stripe").corridor.material.oddColor.getValue(date)
      );
      expect(e.corridor.material.offset.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_stripe").corridor.material.offset.getValue(date)
      );
      expect(e.corridor.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_stripe").corridor.material.repeat.getValue(date)
      );
      ...
      expect(e.corridor.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_checkerboard").corridor.material.oddColor.getValue(date)
      );
      expect(e.corridor.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_corridor_material_checkerboard").corridor.material.repeat.getValue(date)
      );
      ...
      expect(e.cylinder.material.image.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_image").cylinder.material.image.getValue(date)
      );
      expect(e.cylinder.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_image").cylinder.material.repeat.getValue(date)
      );
      expect(e.cylinder.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_image").cylinder.material.color.getValue(date)
      );
      expect(e.cylinder.material.transparent.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_image").cylinder.material.transparent.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_cylinder_material_grid"))).toBeDefined();
      expect(e.cylinder.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_grid").cylinder.material.color.getValue(date)
      );
      expect(e.cylinder.material.cellAlpha.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_grid").cylinder.material.cellAlpha.getValue(date)
      );
      expect(e.cylinder.material.lineCount.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_grid").cylinder.material.lineCount.getValue(date)
      );
      expect(e.cylinder.material.lineThickness.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_grid").cylinder.material.lineThickness.getValue(date)
      );
      expect(e.cylinder.material.lineOffset.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_grid").cylinder.material.lineOffset.getValue(date)
      );
      ...
      expect(e.cylinder.material.orientation.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_stripe").cylinder.material.orientation.getValue(date)
      );
      expect(e.cylinder.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_stripe").cylinder.material.evenColor.getValue(date)
      );
      expect(e.cylinder.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_stripe").cylinder.material.oddColor.getValue(date)
      );
      expect(e.cylinder.material.offset.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_stripe").cylinder.material.offset.getValue(date)
      );
      expect(e.cylinder.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_stripe").cylinder.material.repeat.getValue(date)
      );
      ...
      expect(e.cylinder.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_checkerboard").cylinder.material.oddColor.getValue(date)
      );
      expect(e.cylinder.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_cylinder_material_checkerboard").cylinder.material.repeat.getValue(date)
      );
      ...
      expect(e.ellipse.material.image.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_image").ellipse.material.image.getValue(date)
      );
      expect(e.ellipse.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_image").ellipse.material.repeat.getValue(date)
      );
      expect(e.ellipse.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_image").ellipse.material.color.getValue(date)
      );
      expect(e.ellipse.material.transparent.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_image").ellipse.material.transparent.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_ellipse_material_grid"))).toBeDefined();
      expect(e.ellipse.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_grid").ellipse.material.color.getValue(date)
      );
      expect(e.ellipse.material.cellAlpha.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_grid").ellipse.material.cellAlpha.getValue(date)
      );
      expect(e.ellipse.material.lineCount.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_grid").ellipse.material.lineCount.getValue(date)
      );
      expect(e.ellipse.material.lineThickness.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_grid").ellipse.material.lineThickness.getValue(date)
      );
      expect(e.ellipse.material.lineOffset.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_grid").ellipse.material.lineOffset.getValue(date)
      );
      ...
      expect(e.ellipse.material.orientation.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_stripe").ellipse.material.orientation.getValue(date)
      );
      expect(e.ellipse.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_stripe").ellipse.material.evenColor.getValue(date)
      );
      expect(e.ellipse.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_stripe").ellipse.material.oddColor.getValue(date)
      );
      expect(e.ellipse.material.offset.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_stripe").ellipse.material.offset.getValue(date)
      );
      expect(e.ellipse.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_stripe").ellipse.material.repeat.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_ellipse_material_checkerboard"))).toBeDefined();
      expect(e.ellipse.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_checkerboard").ellipse.material.evenColor.getValue(date)
      );
      expect(e.ellipse.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_checkerboard").ellipse.material.oddColor.getValue(date)
      );
      expect(e.ellipse.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipse_material_checkerboard").ellipse.material.repeat.getValue(date)
      );
      ...
      expect(e.ellipsoid.material.image.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_image").ellipsoid.material.image.getValue(date)
      );
      expect(e.ellipsoid.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_image").ellipsoid.material.repeat.getValue(date)
      );
      expect(e.ellipsoid.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_image").ellipsoid.material.color.getValue(date)
      );
      expect(e.ellipsoid.material.transparent.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_image").ellipsoid.material.transparent.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_ellipsoid_material_grid"))).toBeDefined();
      expect(e.ellipsoid.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_grid").ellipsoid.material.color.getValue(date)
      );
      expect(e.ellipsoid.material.cellAlpha.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_grid").ellipsoid.material.cellAlpha.getValue(date)
      );
      expect(e.ellipsoid.material.lineCount.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_grid").ellipsoid.material.lineCount.getValue(date)
      );
      expect(e.ellipsoid.material.lineThickness.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_grid").ellipsoid.material.lineThickness.getValue(date)
      );
      expect(e.ellipsoid.material.lineOffset.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_grid").ellipsoid.material.lineOffset.getValue(date)
      );
      ...
      expect(e.ellipsoid.material.orientation.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_stripe").ellipsoid.material.orientation.getValue(date)
      );
      expect(e.ellipsoid.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_stripe").ellipsoid.material.evenColor.getValue(date)
      );
      expect(e.ellipsoid.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_stripe").ellipsoid.material.oddColor.getValue(date)
      );
      expect(e.ellipsoid.material.offset.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_stripe").ellipsoid.material.offset.getValue(date)
      );
      expect(e.ellipsoid.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_stripe").ellipsoid.material.repeat.getValue(date)
      );
      ...
      expect(e.ellipsoid.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_ellipsoid_material_checkerboard").ellipsoid.material.repeat.getValue(date)
      );
      ...
      expect(e.path.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_polylineOutline").path.material.color.getValue(date)
      );
      expect(e.path.material.outlineColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_polylineOutline").path.material.outlineColor.getValue(date)
      );
      expect(e.path.material.outlineWidth.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_polylineOutline").path.material.outlineWidth.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_path_material_polylineArrow"))).toBeDefined();
      expect(e.path.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_polylineArrow").path.material.color.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_path_material_polylineDash"))).toBeDefined();
      expect(e.path.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_polylineDash").path.material.color.getValue(date)
      );
      expect(e.path.material.gapColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_polylineDash").path.material.gapColor.getValue(date)
      );
      expect(e.path.material.dashLength.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_polylineDash").path.material.dashLength.getValue(date)
      );
      expect(e.path.material.dashPattern.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_polylineDash").path.material.dashPattern.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_path_material_polylineGlow"))).toBeDefined();
      expect(e.path.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_polylineGlow").path.material.color.getValue(date)
      );
      expect(e.path.material.glowPower.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_polylineGlow").path.material.glowPower.getValue(date)
      );
      expect(e.path.material.taperPower.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_polylineGlow").path.material.taperPower.getValue(date)
      );
      ...
      expect(e.path.material.image.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_image").path.material.image.getValue(date)
      );
      expect(e.path.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_image").path.material.repeat.getValue(date)
      );
      expect(e.path.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_image").path.material.color.getValue(date)
      );
      expect(e.path.material.transparent.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_image").path.material.transparent.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_path_material_grid"))).toBeDefined();
      expect(e.path.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_grid").path.material.color.getValue(date)
      );
      expect(e.path.material.cellAlpha.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_grid").path.material.cellAlpha.getValue(date)
      );
      expect(e.path.material.lineCount.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_grid").path.material.lineCount.getValue(date)
      );
      expect(e.path.material.lineThickness.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_grid").path.material.lineThickness.getValue(date)
      );
      expect(e.path.material.lineOffset.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_grid").path.material.lineOffset.getValue(date)
      );
      ...
      expect(e.path.material.orientation.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_stripe").path.material.orientation.getValue(date)
      );
      expect(e.path.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_stripe").path.material.evenColor.getValue(date)
      );
      expect(e.path.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_stripe").path.material.oddColor.getValue(date)
      );
      expect(e.path.material.offset.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_stripe").path.material.offset.getValue(date)
      );
      expect(e.path.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_stripe").path.material.repeat.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_path_material_checkerboard"))).toBeDefined();
      expect(e.path.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_checkerboard").path.material.evenColor.getValue(date)
      );
      expect(e.path.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_checkerboard").path.material.oddColor.getValue(date)
      );
      expect(e.path.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_path_material_checkerboard").path.material.repeat.getValue(date)
      );
      ...
      expect(e.polygon.material.image.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_image").polygon.material.image.getValue(date)
      );
      expect(e.polygon.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_image").polygon.material.repeat.getValue(date)
      );
      expect(e.polygon.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_image").polygon.material.color.getValue(date)
      );
      expect(e.polygon.material.transparent.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_image").polygon.material.transparent.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_polygon_material_grid"))).toBeDefined();
      expect(e.polygon.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_grid").polygon.material.color.getValue(date)
      );
      expect(e.polygon.material.cellAlpha.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_grid").polygon.material.cellAlpha.getValue(date)
      );
      expect(e.polygon.material.lineCount.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_grid").polygon.material.lineCount.getValue(date)
      );
      expect(e.polygon.material.lineThickness.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_grid").polygon.material.lineThickness.getValue(date)
      );
      expect(e.polygon.material.lineOffset.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_grid").polygon.material.lineOffset.getValue(date)
      );
      ...
      expect(e.polygon.material.orientation.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_stripe").polygon.material.orientation.getValue(date)
      );
      expect(e.polygon.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_stripe").polygon.material.evenColor.getValue(date)
      );
      expect(e.polygon.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_stripe").polygon.material.oddColor.getValue(date)
      );
      expect(e.polygon.material.offset.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_stripe").polygon.material.offset.getValue(date)
      );
      expect(e.polygon.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_stripe").polygon.material.repeat.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_polygon_material_checkerboard"))).toBeDefined();
      expect(e.polygon.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_checkerboard").polygon.material.evenColor.getValue(date)
      );
      expect(e.polygon.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_checkerboard").polygon.material.oddColor.getValue(date)
      );
      expect(e.polygon.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_polygon_material_checkerboard").polygon.material.repeat.getValue(date)
      );
      ...
      expect(e.polyline.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_polylineOutline").polyline.material.color.getValue(date)
      );
      ...
      expect(e.polyline.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_polylineArrow").polyline.material.color.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_polyline_material_polylineDash"))).toBeDefined();
      expect(e.polyline.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_polylineDash").polyline.material.color.getValue(date)
      );
      expect(e.polyline.material.gapColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_polylineDash").polyline.material.gapColor.getValue(date)
      );
      ...
      expect(e.polyline.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_polylineGlow").polyline.material.color.getValue(date)
      );
      ...
      expect(e.polyline.material.image.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_image").polyline.material.image.getValue(date)
      );
      expect(e.polyline.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_image").polyline.material.repeat.getValue(date)
      );
      expect(e.polyline.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_image").polyline.material.color.getValue(date)
      );
      expect(e.polyline.material.transparent.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_image").polyline.material.transparent.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_polyline_material_grid"))).toBeDefined();
      expect(e.polyline.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_grid").polyline.material.color.getValue(date)
      );
      expect(e.polyline.material.cellAlpha.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_grid").polyline.material.cellAlpha.getValue(date)
      );
      expect(e.polyline.material.lineCount.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_grid").polyline.material.lineCount.getValue(date)
      );
      expect(e.polyline.material.lineThickness.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_grid").polyline.material.lineThickness.getValue(date)
      );
      expect(e.polyline.material.lineOffset.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_grid").polyline.material.lineOffset.getValue(date)
      );
      ...
      expect(e.polyline.material.orientation.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_stripe").polyline.material.orientation.getValue(date)
      );
      expect(e.polyline.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_stripe").polyline.material.evenColor.getValue(date)
      );
      expect(e.polyline.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_stripe").polyline.material.oddColor.getValue(date)
      );
      expect(e.polyline.material.offset.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_stripe").polyline.material.offset.getValue(date)
      );
      expect(e.polyline.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_stripe").polyline.material.repeat.getValue(date)
      );
      ...
      expect(e.polyline.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_checkerboard").polyline.material.oddColor.getValue(date)
      );
      expect(e.polyline.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_polyline_material_checkerboard").polyline.material.repeat.getValue(date)
      );
      ...
      expect(e.polyline.depthFailMaterial.outlineColor.getValue(date)).toEqual(
        dataSource.entities
          .getById("material_polyline_depthFailMaterial_polylineOutline")
          .polyline.depthFailMaterial.outlineColor.getValue(date)
      );
      expect(e.polyline.depthFailMaterial.outlineWidth.getValue(date)).toEqual(
        dataSource.entities
          .getById("material_polyline_depthFailMaterial_polylineOutline")
      ...
      expect(e.polyline.depthFailMaterial.lineThickness.getValue(date)).toEqual(
        dataSource.entities
          .getById("material_polyline_depthFailMaterial_grid")
      ...
      expect(e.rectangle.material.image.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_image").rectangle.material.image.getValue(date)
      );
      expect(e.rectangle.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_image").rectangle.material.repeat.getValue(date)
      );
      expect(e.rectangle.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_image").rectangle.material.color.getValue(date)
      );
      expect(e.rectangle.material.transparent.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_image").rectangle.material.transparent.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_rectangle_material_grid"))).toBeDefined();
      expect(e.rectangle.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_grid").rectangle.material.color.getValue(date)
      );
      expect(e.rectangle.material.cellAlpha.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_grid").rectangle.material.cellAlpha.getValue(date)
      );
      expect(e.rectangle.material.lineCount.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_grid").rectangle.material.lineCount.getValue(date)
      );
      expect(e.rectangle.material.lineThickness.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_grid").rectangle.material.lineThickness.getValue(date)
      );
      expect(e.rectangle.material.lineOffset.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_grid").rectangle.material.lineOffset.getValue(date)
      );
      ...
      expect(e.rectangle.material.orientation.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_stripe").rectangle.material.orientation.getValue(date)
      );
      expect(e.rectangle.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_stripe").rectangle.material.evenColor.getValue(date)
      );
      expect(e.rectangle.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_stripe").rectangle.material.oddColor.getValue(date)
      );
      expect(e.rectangle.material.offset.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_stripe").rectangle.material.offset.getValue(date)
      );
      expect(e.rectangle.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_stripe").rectangle.material.repeat.getValue(date)
      );
      ...
      expect(e.rectangle.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_rectangle_material_checkerboard").rectangle.material.repeat.getValue(date)
      );
      ...
      expect(e.wall.material.image.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_image").wall.material.image.getValue(date)
      );
      expect(e.wall.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_image").wall.material.repeat.getValue(date)
      );
      expect(e.wall.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_image").wall.material.color.getValue(date)
      );
      expect(e.wall.material.transparent.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_image").wall.material.transparent.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_wall_material_grid"))).toBeDefined();
      expect(e.wall.material.color.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_grid").wall.material.color.getValue(date)
      );
      expect(e.wall.material.cellAlpha.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_grid").wall.material.cellAlpha.getValue(date)
      );
      expect(e.wall.material.lineCount.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_grid").wall.material.lineCount.getValue(date)
      );
      expect(e.wall.material.lineThickness.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_grid").wall.material.lineThickness.getValue(date)
      );
      expect(e.wall.material.lineOffset.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_grid").wall.material.lineOffset.getValue(date)
      );
      ...
      expect(e.wall.material.orientation.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_stripe").wall.material.orientation.getValue(date)
      );
      expect(e.wall.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_stripe").wall.material.evenColor.getValue(date)
      );
      expect(e.wall.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_stripe").wall.material.oddColor.getValue(date)
      );
      expect(e.wall.material.offset.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_stripe").wall.material.offset.getValue(date)
      );
      expect(e.wall.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_stripe").wall.material.repeat.getValue(date)
      );
      expect((e = dataSource.entities.getById("reference_wall_material_checkerboard"))).toBeDefined();
      expect(e.wall.material.evenColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_checkerboard").wall.material.evenColor.getValue(date)
      );
      expect(e.wall.material.oddColor.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_checkerboard").wall.material.oddColor.getValue(date)
      );
      expect(e.wall.material.repeat.getValue(date)).toEqual(
        dataSource.entities.getById("material_wall_material_checkerboard").wall.material.repeat.getValue(date)
      );
      ...
      expect(
        (e = dataSource.entities.getById("reference_conicSensor_lateralSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("reference_conicSensor_ellipsoidSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_conicSensor_ellipsoidHorizonSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_conicSensor_ellipsoidHorizonSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_conicSensor_ellipsoidHorizonSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_conicSensor_ellipsoidHorizonSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("reference_conicSensor_environmentOcclusionMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_conicSensor_environmentOcclusionMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_conicSensor_environmentOcclusionMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_conicSensor_environmentOcclusionMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_lateralSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_lateralSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_lateralSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_lateralSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_ellipsoidSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_ellipsoidSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_ellipsoidSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_ellipsoidSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_ellipsoidHorizonSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_ellipsoidHorizonSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_ellipsoidHorizonSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_ellipsoidHorizonSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_domeSurfaceMaterial_image"))
      ).toBeDefined();
      expect((e = dataSource.entities.getById("reference_customPatternSensor_domeSurfaceMaterial_grid"))).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_domeSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_domeSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_environmentOcclusionMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_environmentOcclusionMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_environmentOcclusionMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_customPatternSensor_environmentOcclusionMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_lateralSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_lateralSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_lateralSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_lateralSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_ellipsoidSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_ellipsoidSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_ellipsoidSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_ellipsoidSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_ellipsoidHorizonSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_ellipsoidHorizonSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_ellipsoidHorizonSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_ellipsoidHorizonSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_domeSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_environmentOcclusionMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_environmentOcclusionMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_environmentOcclusionMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("reference_rectangularSensor_environmentOcclusionMaterial_checkerboard"))
      ).toBeDefined();
      ...
      expect(e.position.getValue(JulianDate.addSeconds(documentStartDate, 60, new JulianDate()))).toEqual(
        new Cartesian3(61, 122, 183)
      );
      expect((e = dataSource.entities.getById("velocityReference_billboard_alignedAxis"))).toBeDefined();
      expect(
        e.billboard.alignedAxis.getValue(JulianDate.addSeconds(documentStartDate, 50, new JulianDate()))
      ).toEqualEpsilon(new Cartesian3(0.267261241912424, 0.534522483824849, 0.801783725737273), 1e-13);
      ...
      expect(e.orientation.getValue(documentStartDate)).toEqualEpsilon(
        new Quaternion(0.63382030572505, 0.114406464045845, 0.748788933003267, 0.156518736408648),
        1e-14
      );
      expect(e.orientation.getValue(documentStopDate)).toEqualEpsilon(
        new Quaternion(0.670778929875422, 0.608790403475694, 0.320013828781515, 0.277526613606122),
        1e-14
      );
      ...
      expect(e.billboard.alignedAxis.getValue(documentStartDate)).toEqualEpsilon(
        new Cartesian3(0.971559394453729, 0.230094854374832, 0.0559347927405484),
        1e-14
      );
      expect(e.billboard.alignedAxis.getValue(documentStopDate)).toEqualEpsilon(
        new Cartesian3(0.384810775516236, 0.82287332508932, 0.418091088045462),
        1e-14
      );
      ...
      expect(e.billboard.translucencyByDistance.getValue(documentStartDate)).toEqual(
        new NearFarScalar(64366, 52219, 8139, 10015)
      );
      expect(e.billboard.translucencyByDistance.getValue(documentStopDate)).toEqual(
        new NearFarScalar(10918, 18986, 49738, 60610)
      );
      expect(e.billboard.pixelOffsetScaleByDistance.getValue(documentStartDate)).toEqual(
        new NearFarScalar(54503, 26068, 41061, 59552)
      );
      expect(e.billboard.pixelOffsetScaleByDistance.getValue(documentStopDate)).toEqual(
        new NearFarScalar(37417, 4754, 19986, 15182)
      );
      ...
      expect(e.billboard.distanceDisplayCondition.getValue(documentStartDate)).toEqual(
        new DistanceDisplayCondition(952, 47317)
      );
      expect(e.billboard.distanceDisplayCondition.getValue(documentStopDate)).toEqual(
        new DistanceDisplayCondition(16896, 28226)
      );
      ...
      expect(e.box.distanceDisplayCondition.getValue(documentStartDate)).toEqual(
        new DistanceDisplayCondition(8940, 60664)
      );
      expect(e.box.distanceDisplayCondition.getValue(documentStopDate)).toEqual(
        new DistanceDisplayCondition(41202, 60832)
      );
      ...
      expect(e.corridor.distanceDisplayCondition.getValue(documentStartDate)).toEqual(
        new DistanceDisplayCondition(10884, 63530)
      );
      expect(e.corridor.distanceDisplayCondition.getValue(documentStopDate)).toEqual(
        new DistanceDisplayCondition(20076, 27683)
      );
      ...
      expect(e.cylinder.distanceDisplayCondition.getValue(documentStartDate)).toEqual(
        new DistanceDisplayCondition(2783, 57220)
      );
      expect(e.cylinder.distanceDisplayCondition.getValue(documentStopDate)).toEqual(
        new DistanceDisplayCondition(13855, 50230)
      );
      ...
      expect(e.ellipse.distanceDisplayCondition.getValue(documentStartDate)).toEqual(
        new DistanceDisplayCondition(38393, 63947)
      );
      expect(e.ellipse.distanceDisplayCondition.getValue(documentStopDate)).toEqual(
        new DistanceDisplayCondition(29119, 43121)
      );
      ...
      expect(e.ellipsoid.distanceDisplayCondition.getValue(documentStartDate)).toEqual(
        new DistanceDisplayCondition(11751, 59227)
      );
      expect(e.ellipsoid.distanceDisplayCondition.getValue(documentStopDate)).toEqual(
        new DistanceDisplayCondition(4769, 41441)
      );
      ...
      expect(e.label.translucencyByDistance.getValue(documentStartDate)).toEqual(
        new NearFarScalar(25055, 32865, 32128, 29309)
      );
      expect(e.label.translucencyByDistance.getValue(documentStopDate)).toEqual(
        new NearFarScalar(58875, 9189, 20515, 15696)
      );
      expect(e.label.pixelOffsetScaleByDistance.getValue(documentStartDate)).toEqual(
        new NearFarScalar(45296, 62896, 38133, 40084)
      );
      expect(e.label.pixelOffsetScaleByDistance.getValue(documentStopDate)).toEqual(
        new NearFarScalar(28657, 25711, 9316, 62756)
      );
      ...
      expect(e.label.distanceDisplayCondition.getValue(documentStartDate)).toEqual(
        new DistanceDisplayCondition(2314, 2614)
      );
      expect(e.label.distanceDisplayCondition.getValue(documentStopDate)).toEqual(
        new DistanceDisplayCondition(23998, 48733)
      );
      ...
      expect(e.model.distanceDisplayCondition.getValue(documentStartDate)).toEqual(
        new DistanceDisplayCondition(33246, 36993)
      );
      expect(e.model.distanceDisplayCondition.getValue(documentStopDate)).toEqual(
        new DistanceDisplayCondition(5814, 10006)
      );
      ...
      expect(e.path.distanceDisplayCondition.getValue(documentStartDate)).toEqual(
        new DistanceDisplayCondition(42994, 62047)
      );
      expect(e.path.distanceDisplayCondition.getValue(documentStopDate)).toEqual(
        new DistanceDisplayCondition(52406, 59340)
      );
      ...
      expect(e.point.translucencyByDistance.getValue(documentStartDate)).toEqual(
        new NearFarScalar(61190, 16879, 16449, 10048)
      );
      expect(e.point.translucencyByDistance.getValue(documentStopDate)).toEqual(
        new NearFarScalar(46491, 47541, 35769, 13707)
      );
      expect(e.point.distanceDisplayCondition.getValue(documentStartDate)).toEqual(
        new DistanceDisplayCondition(7642, 55841)
      );
      expect(e.point.distanceDisplayCondition.getValue(documentStopDate)).toEqual(
        new DistanceDisplayCondition(24270, 29534)
      );
      ...
      expect(e.polygon.distanceDisplayCondition.getValue(documentStartDate)).toEqual(
        new DistanceDisplayCondition(22140, 31962)
      );
      expect(e.polygon.distanceDisplayCondition.getValue(documentStopDate)).toEqual(
        new DistanceDisplayCondition(3927, 22422)
      );
      ...
      expect(e.polyline.depthFailMaterial.color.getValue(documentStartDate)).toEqual(
        Color.fromBytes(217, 122, 10, 152)
      );
      expect(e.polyline.depthFailMaterial.color.getValue(documentStopDate)).toEqual(Color.fromBytes(76, 105, 5, 67));
      expect(e.polyline.distanceDisplayCondition.getValue(documentStartDate)).toEqual(
        new DistanceDisplayCondition(4857, 10258)
      );
      expect(e.polyline.distanceDisplayCondition.getValue(documentStopDate)).toEqual(
        new DistanceDisplayCondition(36588, 47246)
      );
      ...
      expect(e.rectangle.coordinates.getValue(documentStartDate)).toEqual(
        new Rectangle(0.392205830501108, 1.04907471338688, 0.00211010473645246, 0.064281089310235)
      );
      expect(e.rectangle.coordinates.getValue(documentStopDate)).toEqual(
        new Rectangle(0.523469985903937, 0.229690388867811, 0.399550037703662, 0.48478405941078)
      );
      ...
      expect(e.rectangle.distanceDisplayCondition.getValue(documentStartDate)).toEqual(
        new DistanceDisplayCondition(24813, 30560)
      );
      expect(e.rectangle.distanceDisplayCondition.getValue(documentStopDate)).toEqual(
        new DistanceDisplayCondition(34617, 40071)
      );
      ...
      expect(e.wall.distanceDisplayCondition.getValue(documentStartDate)).toEqual(
        new DistanceDisplayCondition(12470, 36912)
      );
      expect(e.wall.distanceDisplayCondition.getValue(documentStopDate)).toEqual(
        new DistanceDisplayCondition(35574, 63040)
      );
      ...
      expect(e.billboard.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.0235294117647059, 0.427450980392157, 0.658823529411765, 0.0980392156862745),
        1e-14
      );
      expect(e.billboard.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.968627450980392, 0.752941176470588, 0.843137254901961, 0.164705882352941),
        1e-14
      );
      ...
      expect(e.box.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.556862745098039, 0.541176470588235, 0.956862745098039, 0.317647058823529),
        1e-14
      );
      expect(e.box.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.792156862745098, 0.92156862745098, 0.125490196078431, 0.784313725490196),
        1e-14
      );
      ...
      expect(e.box.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.149019607843137, 0.929411764705882, 0.462745098039216, 0.764705882352941),
        1e-14
      );
      expect(e.box.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.890196078431372, 0.262745098039216, 0.866666666666667, 0.792156862745098),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_box_material_grid_color"))).toBeDefined();
      expect(e.box.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.501960784313725, 0.447058823529412, 0.72156862745098, 0.392156862745098),
        1e-14
      );
      expect(e.box.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.890196078431372, 0.505882352941176, 0.56078431372549, 0.674509803921569),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_box_material_stripe_evenColor"))).toBeDefined();
      expect(e.box.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.980392156862745, 0.345098039215686, 0.929411764705882, 0.533333333333333),
        1e-14
      );
      expect(e.box.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.988235294117647, 0.372549019607843, 0.713725490196078, 0.466666666666667),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_box_material_stripe_oddColor"))).toBeDefined();
      expect(e.box.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.545098039215686, 0.168627450980392, 0.654901960784314, 0.196078431372549),
        1e-14
      );
      expect(e.box.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.407843137254902, 0.450980392156863, 0.874509803921569, 0.603921568627451),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_box_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.box.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.137254901960784, 0.937254901960784, 0.513725490196078, 0.87843137254902),
        1e-14
      );
      expect(e.box.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.72156862745098, 0.0666666666666667, 0.274509803921569, 0.207843137254902),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_box_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.box.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.352941176470588, 0.274509803921569, 0.850980392156863, 0.00784313725490196),
        1e-14
      );
      expect(e.box.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.83921568627451, 0.780392156862745, 0.796078431372549, 0.384313725490196),
        1e-14
      );
      ...
      expect(e.box.outlineColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.215686274509804, 0.498039215686275, 0.274509803921569, 0.129411764705882),
        1e-14
      );
      expect(e.box.outlineColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.854901960784314, 0.729411764705882, 0.172549019607843, 0.956862745098039),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_corridor_material_solidColor_color"))).toBeDefined();
      expect(e.corridor.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.858823529411765, 0.988235294117647, 0.733333333333333, 0.690196078431373),
        1e-14
      );
      expect(e.corridor.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.549019607843137, 0.368627450980392, 0.964705882352941, 0.133333333333333),
        1e-14
      );
      ...
      expect(e.corridor.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.949019607843137, 0.666666666666667, 0.0588235294117647, 0.784313725490196),
        1e-14
      );
      expect(e.corridor.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.388235294117647, 0.262745098039216, 0.764705882352941, 0.882352941176471),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_corridor_material_grid_color"))).toBeDefined();
      expect(e.corridor.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.290196078431373, 0.83921568627451, 0.588235294117647, 0.525490196078431),
        1e-14
      );
      expect(e.corridor.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.266666666666667, 0.00392156862745098, 0.180392156862745, 0.701960784313725),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_corridor_material_stripe_evenColor"))).toBeDefined();
      expect(e.corridor.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.517647058823529, 0.282352941176471, 0.709803921568627, 0.737254901960784),
        1e-14
      );
      expect(e.corridor.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.564705882352941, 0.407843137254902, 0.945098039215686, 0.666666666666667),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_corridor_material_stripe_oddColor"))).toBeDefined();
      expect(e.corridor.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.137254901960784, 0.4, 0.356862745098039, 0.501960784313725),
        1e-14
      );
      expect(e.corridor.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.992156862745098, 0.431372549019608, 0.301960784313725, 0.254901960784314),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_corridor_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.corridor.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.294117647058824, 0.0588235294117647, 0.149019607843137, 0.756862745098039),
        1e-14
      );
      expect(e.corridor.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.243137254901961, 0.56078431372549, 0.254901960784314, 0.83921568627451),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_corridor_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.corridor.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.768627450980392, 0.650980392156863, 0.529411764705882, 0.372549019607843),
        1e-14
      );
      expect(e.corridor.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.12156862745098, 0.780392156862745, 0.745098039215686, 0.725490196078431),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_corridor_outlineColor_rgbaf"))).toBeDefined();
      expect(e.corridor.outlineColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.882352941176471, 0.262745098039216, 0.247058823529412, 0.937254901960784),
        1e-14
      );
      expect(e.corridor.outlineColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.701960784313725, 0.262745098039216, 0.0627450980392157, 0.627450980392157),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_cylinder_material_solidColor_color"))).toBeDefined();
      expect(e.cylinder.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.117647058823529, 0.349019607843137, 0.411764705882353, 0.105882352941176),
        1e-14
      );
      expect(e.cylinder.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.513725490196078, 0.513725490196078, 0.666666666666667, 0.596078431372549),
        1e-14
      );
      ...
      expect(e.cylinder.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.76078431372549, 0.133333333333333, 0.231372549019608, 0.631372549019608),
        1e-14
      );
      expect(e.cylinder.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.882352941176471, 0.0823529411764706, 0.8, 0.0823529411764706),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_cylinder_material_grid_color"))).toBeDefined();
      expect(e.cylinder.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.176470588235294, 0.407843137254902, 0.623529411764706, 0.729411764705882),
        1e-14
      );
      expect(e.cylinder.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.43921568627451, 0.0745098039215686, 0.603921568627451, 0.713725490196078),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_cylinder_material_stripe_evenColor"))).toBeDefined();
      expect(e.cylinder.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.380392156862745, 0.149019607843137, 0.8, 0.658823529411765),
        1e-14
      );
      expect(e.cylinder.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.462745098039216, 0.172549019607843, 0.325490196078431, 0.854901960784314),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_cylinder_material_stripe_oddColor"))).toBeDefined();
      expect(e.cylinder.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.207843137254902, 0.466666666666667, 0.427450980392157, 0.109803921568627),
        1e-14
      );
      expect(e.cylinder.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.313725490196078, 0.498039215686275, 0.2, 0.423529411764706),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_cylinder_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.cylinder.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.52156862745098, 0.72156862745098, 0.294117647058824, 0.513725490196078),
        1e-14
      );
      expect(e.cylinder.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.964705882352941, 0.411764705882353, 0.0549019607843137, 0.0392156862745098),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_cylinder_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.cylinder.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.784313725490196, 0.309803921568627, 0.0666666666666667, 0.403921568627451),
        1e-14
      );
      expect(e.cylinder.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.643137254901961, 0.737254901960784, 0.337254901960784, 0.925490196078431),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_cylinder_outlineColor_rgbaf"))).toBeDefined();
      expect(e.cylinder.outlineColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.780392156862745, 0.658823529411765, 0.235294117647059, 0.0705882352941176),
        1e-14
      );
      expect(e.cylinder.outlineColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.643137254901961, 0.372549019607843, 0.16078431372549, 0.588235294117647),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_ellipse_material_solidColor_color"))).toBeDefined();
      expect(e.ellipse.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.67843137254902, 0.807843137254902, 0.541176470588235, 0.290196078431373),
        1e-14
      );
      expect(e.ellipse.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.749019607843137, 0.258823529411765, 0.733333333333333, 0.247058823529412),
        1e-14
      );
      ...
      expect(e.ellipse.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.207843137254902, 0.0392156862745098, 0.12156862745098, 0.611764705882353),
        1e-14
      );
      expect(e.ellipse.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.611764705882353, 0.0117647058823529, 0.694117647058824, 0.576470588235294),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_ellipse_material_grid_color"))).toBeDefined();
      expect(e.ellipse.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.580392156862745, 0.0313725490196078, 0.27843137254902, 0.203921568627451),
        1e-14
      );
      expect(e.ellipse.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.0509803921568627, 0.870588235294118, 0.117647058823529, 0.588235294117647),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_ellipse_material_stripe_evenColor"))).toBeDefined();
      expect(e.ellipse.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.0549019607843137, 0.117647058823529, 0.623529411764706, 0.929411764705882),
        1e-14
      );
      expect(e.ellipse.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.266666666666667, 0.113725490196078, 0.937254901960784, 0.168627450980392),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_ellipse_material_stripe_oddColor"))).toBeDefined();
      expect(e.ellipse.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.262745098039216, 0.172549019607843, 0.282352941176471, 0.129411764705882),
        1e-14
      );
      expect(e.ellipse.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.968627450980392, 0.635294117647059, 0.525490196078431, 0.831372549019608),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_ellipse_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.ellipse.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.207843137254902, 0.156862745098039, 0.952941176470588, 0.717647058823529),
        1e-14
      );
      expect(e.ellipse.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.635294117647059, 0.835294117647059, 0.76078431372549, 0.235294117647059),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_ellipse_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.ellipse.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.890196078431372, 0.141176470588235, 0.231372549019608, 0.623529411764706),
        1e-14
      );
      expect(e.ellipse.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.192156862745098, 0.294117647058824, 0.741176470588235, 0.0274509803921569),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_ellipse_outlineColor_rgbaf"))).toBeDefined();
      expect(e.ellipse.outlineColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.76078431372549, 0.36078431372549, 0.223529411764706, 0.611764705882353),
        1e-14
      );
      expect(e.ellipse.outlineColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.16078431372549, 0.83921568627451, 0.752941176470588, 0.647058823529412),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_ellipsoid_material_solidColor_color"))).toBeDefined();
      expect(e.ellipsoid.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.592156862745098, 0.976470588235294, 0.207843137254902, 0.501960784313725),
        1e-14
      );
      expect(e.ellipsoid.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.0901960784313725, 0.662745098039216, 0.819607843137255, 0.235294117647059),
        1e-14
      );
      ...
      expect(e.ellipsoid.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.654901960784314, 0.517647058823529, 0.858823529411765, 0.486274509803922),
        1e-14
      );
      expect(e.ellipsoid.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.862745098039216, 0.713725490196078, 0.564705882352941, 0.0901960784313725),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_ellipsoid_material_grid_color"))).toBeDefined();
      expect(e.ellipsoid.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.6, 0.427450980392157, 0.203921568627451, 0.223529411764706),
        1e-14
      );
      expect(e.ellipsoid.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.525490196078431, 0.305882352941176, 0.16078431372549, 0.819607843137255),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_ellipsoid_material_stripe_evenColor"))).toBeDefined();
      expect(e.ellipsoid.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.301960784313725, 0.572549019607843, 0.87843137254902, 0.219607843137255),
        1e-14
      );
      expect(e.ellipsoid.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.337254901960784, 0.835294117647059, 0.964705882352941, 0.909803921568627),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_ellipsoid_material_stripe_oddColor"))).toBeDefined();
      expect(e.ellipsoid.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.647058823529412, 0.635294117647059, 0.258823529411765, 0.250980392156863),
        1e-14
      );
      expect(e.ellipsoid.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.917647058823529, 0.262745098039216, 0.666666666666667, 0.980392156862745),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_ellipsoid_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.ellipsoid.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.819607843137255, 0.282352941176471, 0.929411764705882, 0.501960784313725),
        1e-14
      );
      expect(e.ellipsoid.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.850980392156863, 0.294117647058824, 0.498039215686275, 0.956862745098039),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_ellipsoid_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.ellipsoid.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.227450980392157, 0.862745098039216, 0.890196078431372, 0.207843137254902),
        1e-14
      );
      expect(e.ellipsoid.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.796078431372549, 0.0470588235294118, 0.843137254901961, 0.388235294117647),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_ellipsoid_outlineColor_rgbaf"))).toBeDefined();
      expect(e.ellipsoid.outlineColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.552941176470588, 0.549019607843137, 0.431372549019608, 0.568627450980392),
        1e-14
      );
      expect(e.ellipsoid.outlineColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.435294117647059, 0.698039215686274, 0.396078431372549, 0.772549019607843),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_label_backgroundColor_rgbaf"))).toBeDefined();
      expect(e.label.backgroundColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.96078431372549, 0.188235294117647, 0.870588235294118, 0.270588235294118),
        1e-14
      );
      expect(e.label.backgroundColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.882352941176471, 0.796078431372549, 0.603921568627451, 0.823529411764706),
        1e-14
      );
      ...
      expect(e.label.fillColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.709803921568627, 0.556862745098039, 0.337254901960784, 0.247058823529412),
        1e-14
      );
      expect(e.label.fillColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.43921568627451, 0.694117647058824, 0.901960784313726, 0.0823529411764706),
        1e-14
      );
      ...
      expect(e.label.outlineColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.631372549019608, 0.709803921568627, 0.270588235294118, 0.792156862745098),
        1e-14
      );
      expect(e.label.outlineColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.435294117647059, 0.176470588235294, 0.235294117647059, 0.631372549019608),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_model_silhouetteColor_rgbaf"))).toBeDefined();
      expect(e.model.silhouetteColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.231372549019608, 0.866666666666667, 0.266666666666667, 0.635294117647059),
        1e-14
      );
      expect(e.model.silhouetteColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.749019607843137, 0.227450980392157, 0.807843137254902, 0.0823529411764706),
        1e-14
      );
      ...
      expect(e.model.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.0509803921568627, 0.83921568627451, 0.470588235294118, 0.956862745098039),
        1e-14
      );
      expect(e.model.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.435294117647059, 0.945098039215686, 0.431372549019608, 0.619607843137255),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_path_material_solidColor_color"))).toBeDefined();
      expect(e.path.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.517647058823529, 0.56078431372549, 0.254901960784314, 0.494117647058824),
        1e-14
      );
      expect(e.path.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.905882352941176, 0.152941176470588, 0.854901960784314, 0.890196078431372),
        1e-14
      );
      ...
      expect(e.path.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.490196078431373, 0.498039215686275, 0.819607843137255, 0.72156862745098),
        1e-14
      );
      expect(e.path.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.309803921568627, 0.329411764705882, 0.807843137254902, 0.368627450980392),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_path_material_polylineOutline_outlineColor"))).toBeDefined();
      expect(e.path.material.outlineColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.427450980392157, 0.96078431372549, 0.996078431372549, 0.662745098039216),
        1e-14
      );
      expect(e.path.material.outlineColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.917647058823529, 0.635294117647059, 0.674509803921569, 0.298039215686275),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_path_material_polylineArrow_color"))).toBeDefined();
      expect(e.path.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.0666666666666667, 0.972549019607843, 0.686274509803922, 0.325490196078431),
        1e-14
      );
      expect(e.path.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.2, 0.482352941176471, 0.498039215686275, 0.219607843137255),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_path_material_polylineDash_color"))).toBeDefined();
      expect(e.path.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.803921568627451, 0.67843137254902, 0.176470588235294, 0.709803921568627),
        1e-14
      );
      expect(e.path.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.674509803921569, 0.0980392156862745, 0.447058823529412, 0.803921568627451),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_path_material_polylineDash_gapColor"))).toBeDefined();
      expect(e.path.material.gapColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.231372549019608, 0.745098039215686, 0.772549019607843, 0.901960784313726),
        1e-14
      );
      expect(e.path.material.gapColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.713725490196078, 0.180392156862745, 0.317647058823529, 0.309803921568627),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_path_material_polylineGlow_color"))).toBeDefined();
      expect(e.path.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.63921568627451, 0.2, 0.0196078431372549, 0.984313725490196),
        1e-14
      );
      expect(e.path.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.376470588235294, 0.815686274509804, 0.933333333333333, 0.0235294117647059),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_path_material_image_color"))).toBeDefined();
      expect(e.path.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.898039215686275, 0.772549019607843, 0.294117647058824, 0.0431372549019608),
        1e-14
      );
      expect(e.path.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.815686274509804, 0.0901960784313725, 0.898039215686275, 0.309803921568627),
        1e-14
      );
      ...
      expect(e.path.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.474509803921569, 0.690196078431373, 0.0431372549019608, 0.258823529411765),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_path_material_stripe_evenColor"))).toBeDefined();
      expect(e.path.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.368627450980392, 0.584313725490196, 0.831372549019608, 0.541176470588235),
        1e-14
      );
      expect(e.path.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.317647058823529, 0.4, 0.83921568627451, 0.537254901960784),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_path_material_stripe_oddColor"))).toBeDefined();
      expect(e.path.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.145098039215686, 0.588235294117647, 0.917647058823529, 0.607843137254902),
        1e-14
      );
      expect(e.path.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.117647058823529, 0.0705882352941176, 0.901960784313726, 0.525490196078431),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_path_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.path.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.631372549019608, 0.741176470588235, 0.282352941176471, 0.196078431372549),
        1e-14
      );
      expect(e.path.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.250980392156863, 0.109803921568627, 0.188235294117647, 0.796078431372549),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_path_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.path.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.388235294117647, 0.129411764705882, 0.333333333333333, 0.658823529411765),
        1e-14
      );
      expect(e.path.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.156862745098039, 0.631372549019608, 0.290196078431373, 0.713725490196078),
        1e-14
      );
      ...
      expect(e.point.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.67843137254902, 0.356862745098039, 0.588235294117647, 0.796078431372549),
        1e-14
      );
      expect(e.point.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.968627450980392, 0.298039215686275, 0.513725490196078, 0.631372549019608),
        1e-14
      );
      ...
      expect(e.point.outlineColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.427450980392157, 0.894117647058824, 0.168627450980392, 0.768627450980392),
        1e-14
      );
      expect(e.point.outlineColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.458823529411765, 0.466666666666667, 0.388235294117647, 0.792156862745098),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polygon_material_solidColor_color"))).toBeDefined();
      expect(e.polygon.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.305882352941176, 0.615686274509804, 0.337254901960784, 0.894117647058824),
        1e-14
      );
      expect(e.polygon.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.184313725490196, 0.619607843137255, 0.352941176470588, 0.0313725490196078),
        1e-14
      );
      ...
      expect(e.polygon.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.501960784313725, 0.0823529411764706, 0.282352941176471, 0.305882352941176),
        1e-14
      );
      expect(e.polygon.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.0745098039215686, 0.654901960784314, 0.6, 0.886274509803922),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polygon_material_grid_color"))).toBeDefined();
      expect(e.polygon.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.192156862745098, 0.709803921568627, 0.807843137254902, 0.737254901960784),
        1e-14
      );
      expect(e.polygon.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.674509803921569, 0.0235294117647059, 0.764705882352941, 0.976470588235294),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polygon_material_stripe_evenColor"))).toBeDefined();
      expect(e.polygon.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.568627450980392, 0.352941176470588, 0.396078431372549, 0.435294117647059),
        1e-14
      );
      expect(e.polygon.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.274509803921569, 0.43921568627451, 0.686274509803922, 0.419607843137255),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polygon_material_stripe_oddColor"))).toBeDefined();
      expect(e.polygon.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.325490196078431, 0.349019607843137, 0.580392156862745, 0.725490196078431),
        1e-14
      );
      expect(e.polygon.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.568627450980392, 0.690196078431373, 0.00392156862745098, 0.858823529411765),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polygon_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.polygon.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.831372549019608, 0.454901960784314, 0.882352941176471, 0.270588235294118),
        1e-14
      );
      expect(e.polygon.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.494117647058824, 0.384313725490196, 0.345098039215686, 0.16078431372549),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polygon_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.polygon.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.0117647058823529, 0.905882352941176, 0.592156862745098, 0.784313725490196),
        1e-14
      );
      expect(e.polygon.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.427450980392157, 0.701960784313725, 0.0901960784313725, 0.643137254901961),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polygon_outlineColor_rgbaf"))).toBeDefined();
      expect(e.polygon.outlineColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.674509803921569, 0.556862745098039, 0.113725490196078, 0.6),
        1e-14
      );
      expect(e.polygon.outlineColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.650980392156863, 0.827450980392157, 0.537254901960784, 0.713725490196078),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_material_solidColor_color"))).toBeDefined();
      expect(e.polyline.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.976470588235294, 0.949019607843137, 0.450980392156863, 0.466666666666667),
        1e-14
      );
      expect(e.polyline.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.262745098039216, 0.509803921568627, 0.537254901960784, 0.850980392156863),
        1e-14
      );
      ...
      expect(e.polyline.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.384313725490196, 0.168627450980392, 0.443137254901961, 0.658823529411765),
        1e-14
      );
      expect(e.polyline.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.0274509803921569, 0.647058823529412, 0.396078431372549, 0.105882352941176),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_material_polylineOutline_outlineColor"))).toBeDefined();
      expect(e.polyline.material.outlineColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.0823529411764706, 0.0549019607843137, 0.149019607843137, 0.580392156862745),
        1e-14
      );
      expect(e.polyline.material.outlineColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.733333333333333, 0.792156862745098, 0.63921568627451, 0.564705882352941),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_material_polylineArrow_color"))).toBeDefined();
      expect(e.polyline.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.52156862745098, 0.725490196078431, 0.87843137254902, 0.823529411764706),
        1e-14
      );
      expect(e.polyline.material.color.getValue(documentStopDate)).toEqualEpsilon(
      ...
      expect(e.polyline.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.525490196078431, 0.992156862745098, 0.964705882352941, 0.364705882352941),
        1e-14
      );
      expect(e.polyline.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.27843137254902, 0.133333333333333, 0.447058823529412, 0.192156862745098),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_material_polylineDash_gapColor"))).toBeDefined();
      expect(e.polyline.material.gapColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.498039215686275, 0.776470588235294, 0.803921568627451, 0.690196078431373),
        1e-14
      );
      expect(e.polyline.material.gapColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.376470588235294, 0.898039215686275, 0.168627450980392, 0.898039215686275),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_material_polylineGlow_color"))).toBeDefined();
      expect(e.polyline.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.705882352941177, 0.901960784313726, 0.0784313725490196, 0.356862745098039),
        1e-14
      );
      expect(e.polyline.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.517647058823529, 0.207843137254902, 0.701960784313725, 0.105882352941176),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_material_image_color"))).toBeDefined();
      expect(e.polyline.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.796078431372549, 0.741176470588235, 0.741176470588235, 0.349019607843137),
        1e-14
      );
      expect(e.polyline.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.925490196078431, 0.266666666666667, 0.0941176470588235, 0.556862745098039),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_material_grid_color"))).toBeDefined();
      expect(e.polyline.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.545098039215686, 0.847058823529412, 0.341176470588235, 0.101960784313725),
        1e-14
      );
      expect(e.polyline.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.431372549019608, 0.952941176470588, 0.184313725490196, 0.184313725490196),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_material_stripe_evenColor"))).toBeDefined();
      expect(e.polyline.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.807843137254902, 0.262745098039216, 0.898039215686275, 0.811764705882353),
        1e-14
      );
      expect(e.polyline.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.415686274509804, 0.968627450980392, 0.0980392156862745, 0.423529411764706),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_material_stripe_oddColor"))).toBeDefined();
      expect(e.polyline.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.427450980392157, 0.407843137254902, 0.470588235294118, 0.874509803921569),
        1e-14
      );
      expect(e.polyline.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
      ...
      expect(e.polyline.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.313725490196078, 0.415686274509804, 0.0823529411764706, 0.576470588235294),
        1e-14
      );
      expect(e.polyline.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.0196078431372549, 0.309803921568627, 0.23921568627451, 0.933333333333333),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.polyline.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.784313725490196, 0.235294117647059, 0.525490196078431, 0.180392156862745),
        1e-14
      );
      expect(e.polyline.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.356862745098039, 0.125490196078431, 0.243137254901961, 0.788235294117647),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_depthFailMaterial_solidColor_color"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.568627450980392, 0.243137254901961, 0.43921568627451, 0.541176470588235),
        1e-14
      );
      expect(e.polyline.depthFailMaterial.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.729411764705882, 0.505882352941176, 0.282352941176471, 0.0274509803921569),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_depthFailMaterial_polylineOutline"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(documentStartDate)).toEqual(
        Color.fromBytes(247, 124, 164, 106)
      );
      expect(e.polyline.depthFailMaterial.color.getValue(documentStopDate)).toEqual(Color.fromBytes(91, 114, 116, 82));
      expect(e.polyline.depthFailMaterial.outlineColor.getValue(documentStartDate)).toEqual(
        Color.fromBytes(35, 216, 157, 243)
      );
      expect(e.polyline.depthFailMaterial.outlineColor.getValue(documentStopDate)).toEqual(
        Color.fromBytes(111, 11, 143, 175)
      );
      ...
      expect(e.polyline.depthFailMaterial.gapColor.getValue(documentStartDate)).toEqual(
        Color.fromBytes(98, 214, 1, 23)
      );
      expect(e.polyline.depthFailMaterial.gapColor.getValue(documentStopDate)).toEqual(
        Color.fromBytes(108, 132, 28, 207)
      );
      ...
      expect(e.polyline.depthFailMaterial.color.getValue(documentStartDate)).toEqual(
        Color.fromBytes(253, 71, 171, 138)
      );
      ...
      expect(e.polyline.depthFailMaterial.color.getValue(documentStartDate)).toEqual(
        Color.fromBytes(206, 138, 53, 173)
      );
      ...
      expect(e.polyline.depthFailMaterial.lineThickness.getValue(documentStartDate)).toEqual(
        new Cartesian2(22967, 31065)
      );
      expect(e.polyline.depthFailMaterial.lineThickness.getValue(documentStopDate)).toEqual(
        new Cartesian2(59168, 51431)
      );
      ...
      expect(e.polyline.depthFailMaterial.evenColor.getValue(documentStartDate)).toEqual(
        Color.fromBytes(166, 16, 249, 230)
      );
      expect(e.polyline.depthFailMaterial.evenColor.getValue(documentStopDate)).toEqual(
        Color.fromBytes(250, 177, 111, 216)
      );
      expect(e.polyline.depthFailMaterial.oddColor.getValue(documentStartDate)).toEqual(
        Color.fromBytes(210, 161, 181, 206)
      );
      expect(e.polyline.depthFailMaterial.oddColor.getValue(documentStopDate)).toEqual(
        Color.fromBytes(194, 73, 70, 224)
      );
      ...
      expect(e.polyline.depthFailMaterial.evenColor.getValue(documentStartDate)).toEqual(
        Color.fromBytes(0, 159, 59, 160)
      );
      expect(e.polyline.depthFailMaterial.evenColor.getValue(documentStopDate)).toEqual(
        Color.fromBytes(202, 33, 125, 165)
      );
      expect(e.polyline.depthFailMaterial.oddColor.getValue(documentStartDate)).toEqual(
        Color.fromBytes(19, 37, 14, 24)
      );
      expect(e.polyline.depthFailMaterial.oddColor.getValue(documentStopDate)).toEqual(
        Color.fromBytes(66, 150, 238, 84)
      );
      ...
      expect(
        (e = dataSource.entities.getById("sampled_polyline_depthFailMaterial_polylineOutline_color"))
      ).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.611764705882353, 0.407843137254902, 0.807843137254902, 0.380392156862745),
        1e-14
      );
      expect(e.polyline.depthFailMaterial.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.52156862745098, 0.654901960784314, 0.756862745098039, 0.368627450980392),
        1e-14
      );
      expect(
        (e = dataSource.entities.getById("sampled_polyline_depthFailMaterial_polylineOutline_outlineColor"))
      ).toBeDefined();
      expect(e.polyline.depthFailMaterial.outlineColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.670588235294118, 0.211764705882353, 0.607843137254902, 0.388235294117647),
        1e-14
      );
      expect(e.polyline.depthFailMaterial.outlineColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.611764705882353, 0.611764705882353, 0.298039215686275, 0.749019607843137),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_depthFailMaterial_polylineArrow_color"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.874509803921569, 0.541176470588235, 0.231372549019608, 0.596078431372549),
        1e-14
      );
      expect(e.polyline.depthFailMaterial.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.729411764705882, 0.533333333333333, 0.411764705882353, 0.454901960784314),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_depthFailMaterial_polylineDash_color"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.776470588235294, 0.0823529411764706, 0.96078431372549, 0.776470588235294),
        1e-14
      );
      expect(e.polyline.depthFailMaterial.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.0941176470588235, 0.643137254901961, 0.717647058823529, 0.890196078431372),
        1e-14
      );
      expect(
        (e = dataSource.entities.getById("sampled_polyline_depthFailMaterial_polylineDash_gapColor"))
      ).toBeDefined();
      expect(e.polyline.depthFailMaterial.gapColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.219607843137255, 0.403921568627451, 0.815686274509804, 0.803921568627451),
        1e-14
      );
      expect(e.polyline.depthFailMaterial.gapColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.294117647058824, 0.615686274509804, 0.172549019607843, 0.0235294117647059),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_depthFailMaterial_polylineGlow_color"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.168627450980392, 0.847058823529412, 0.968627450980392, 0.431372549019608),
        1e-14
      );
      expect(e.polyline.depthFailMaterial.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.2, 0.603921568627451, 0.941176470588235, 0.0901960784313725),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_depthFailMaterial_image_color"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.980392156862745, 0.450980392156863, 0.329411764705882, 0.670588235294118),
        1e-14
      );
      expect(e.polyline.depthFailMaterial.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.556862745098039, 0.63921568627451, 0.156862745098039, 0.705882352941177),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_depthFailMaterial_grid_color"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.623529411764706, 0.607843137254902, 0.913725490196078, 0.596078431372549),
        1e-14
      );
      expect(e.polyline.depthFailMaterial.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.423529411764706, 0.968627450980392, 0.815686274509804, 0.968627450980392),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_depthFailMaterial_stripe_evenColor"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.854901960784314, 0.843137254901961, 0.701960784313725, 0.113725490196078),
        1e-14
      );
      expect(e.polyline.depthFailMaterial.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.941176470588235, 0.890196078431372, 0.933333333333333, 0.588235294117647),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_polyline_depthFailMaterial_stripe_oddColor"))).toBeDefined();
      expect(e.polyline.depthFailMaterial.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.427450980392157, 0.870588235294118, 0.96078431372549, 0.219607843137255),
        1e-14
      );
      expect(e.polyline.depthFailMaterial.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.219607843137255, 0.847058823529412, 0.752941176470588, 0.172549019607843),
        1e-14
      );
      expect(
        (e = dataSource.entities.getById("sampled_polyline_depthFailMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(e.polyline.depthFailMaterial.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.96078431372549, 0.0941176470588235, 0.725490196078431, 0.819607843137255),
        1e-14
      );
      expect(e.polyline.depthFailMaterial.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.0588235294117647, 0.447058823529412, 0.572549019607843, 0.0549019607843137),
        1e-14
      );
      expect(
        (e = dataSource.entities.getById("sampled_polyline_depthFailMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(e.polyline.depthFailMaterial.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.333333333333333, 0.0431372549019608, 0.886274509803922, 0.384313725490196),
        1e-14
      );
      expect(e.polyline.depthFailMaterial.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.235294117647059, 0.733333333333333, 0.752941176470588, 0.537254901960784),
        1e-14
      );
      ...
      expect(e.rectangle.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.203921568627451, 0.243137254901961, 0.576470588235294, 0.0980392156862745),
        1e-14
      );
      expect(e.rectangle.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.913725490196078, 0.831372549019608, 0.76078431372549, 0.952941176470588),
        1e-14
      );
      ...
      expect(e.rectangle.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.552941176470588, 0.101960784313725, 0.772549019607843, 0.00392156862745098),
        1e-14
      );
      expect(e.rectangle.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.0156862745098039, 0.964705882352941, 0.592156862745098, 0.396078431372549),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_rectangle_material_grid_color"))).toBeDefined();
      expect(e.rectangle.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.490196078431373, 0.384313725490196, 0.937254901960784, 0.168627450980392),
        1e-14
      );
      expect(e.rectangle.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.392156862745098, 0.756862745098039, 0.454901960784314, 0.529411764705882),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_rectangle_material_stripe_evenColor"))).toBeDefined();
      expect(e.rectangle.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.32156862745098, 0.776470588235294, 0.227450980392157, 0.0823529411764706),
        1e-14
      );
      expect(e.rectangle.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.929411764705882, 0.725490196078431, 0.00392156862745098, 0.364705882352941),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_rectangle_material_stripe_oddColor"))).toBeDefined();
      expect(e.rectangle.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.984313725490196, 0.831372549019608, 0.827450980392157, 0.925490196078431),
        1e-14
      );
      expect(e.rectangle.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.145098039215686, 0.0156862745098039, 0.380392156862745, 0.490196078431373),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_rectangle_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.rectangle.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.286274509803922, 0.831372549019608, 0.184313725490196, 0.172549019607843),
        1e-14
      );
      expect(e.rectangle.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.596078431372549, 0.603921568627451, 0.694117647058824, 0.235294117647059),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_rectangle_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.rectangle.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.929411764705882, 0.92156862745098, 0.270588235294118, 0.0666666666666667),
        1e-14
      );
      expect(e.rectangle.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.411764705882353, 0.125490196078431, 0.505882352941176, 0.509803921568627),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_rectangle_outlineColor_rgbaf"))).toBeDefined();
      expect(e.rectangle.outlineColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.980392156862745, 0.466666666666667, 0.752941176470588, 0.709803921568627),
        1e-14
      );
      expect(e.rectangle.outlineColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.549019607843137, 0.949019607843137, 0.545098039215686, 0.380392156862745),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_wall_material_solidColor_color"))).toBeDefined();
      expect(e.wall.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.384313725490196, 0.964705882352941, 0.827450980392157, 0.815686274509804),
        1e-14
      );
      expect(e.wall.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.00784313725490196, 0.325490196078431, 0.952941176470588, 0.0549019607843137),
        1e-14
      );
      ...
      expect(e.wall.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.584313725490196, 0.752941176470588, 0.588235294117647, 0.733333333333333),
        1e-14
      );
      expect(e.wall.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.309803921568627, 0.988235294117647, 0.0784313725490196, 0.458823529411765),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_wall_material_grid_color"))).toBeDefined();
      expect(e.wall.material.color.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.27843137254902, 0.549019607843137, 0.964705882352941, 0.96078431372549),
        1e-14
      );
      expect(e.wall.material.color.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.709803921568627, 0.831372549019608, 0.67843137254902, 0.407843137254902),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_wall_material_stripe_evenColor"))).toBeDefined();
      expect(e.wall.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.0901960784313725, 0.243137254901961, 0.537254901960784, 0.168627450980392),
        1e-14
      );
      expect(e.wall.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.388235294117647, 0.847058823529412, 0.258823529411765, 0.113725490196078),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_wall_material_stripe_oddColor"))).toBeDefined();
      expect(e.wall.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.345098039215686, 0.0196078431372549, 0.0549019607843137, 0.662745098039216),
        1e-14
      );
      expect(e.wall.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.694117647058824, 0.890196078431372, 0.380392156862745, 0.317647058823529),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_wall_material_checkerboard_evenColor"))).toBeDefined();
      expect(e.wall.material.evenColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.670588235294118, 0.462745098039216, 0.443137254901961, 0.23921568627451),
        1e-14
      );
      expect(e.wall.material.evenColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.313725490196078, 0.0901960784313725, 0.623529411764706, 0.933333333333333),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_wall_material_checkerboard_oddColor"))).toBeDefined();
      expect(e.wall.material.oddColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.184313725490196, 0.725490196078431, 0.894117647058824, 0.572549019607843),
        1e-14
      );
      expect(e.wall.material.oddColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.745098039215686, 0.435294117647059, 0.611764705882353, 0.776470588235294),
        1e-14
      );
      ...
      expect(e.wall.outlineColor.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.933333333333333, 0.105882352941176, 0.0627450980392157, 0.396078431372549),
        1e-14
      );
      expect(e.wall.outlineColor.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.901960784313726, 0.435294117647059, 0.352941176470588, 0.713725490196078),
        1e-14
      );
      expect((e = dataSource.entities.getById("sampled_conicSensor_intersectionColor_rgbaf"))).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_lateralSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_lateralSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_lateralSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_lateralSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_lateralSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_lateralSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidHorizonSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidHorizonSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidHorizonSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidHorizonSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidHorizonSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidHorizonSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidHorizonSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidHorizonSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidHorizonSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidHorizonSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_ellipsoidHorizonSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_domeSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_domeSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_domeSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_domeSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_domeSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_environmentOcclusionMaterial_solidColor_color"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_environmentOcclusionMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_environmentOcclusionMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_environmentOcclusionMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_environmentOcclusionMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_environmentOcclusionMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_environmentOcclusionMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_environmentOcclusionMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_conicSensor_environmentOcclusionMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_lateralSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_lateralSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_lateralSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_lateralSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_lateralSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_lateralSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_lateralSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_lateralSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_lateralSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_lateralSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_lateralSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById(
      ...
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidHorizonSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidHorizonSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidHorizonSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidHorizonSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidHorizonSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidHorizonSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById(
      ...
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_ellipsoidHorizonSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById(
      ...
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_domeSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_domeSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_domeSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_domeSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_domeSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_domeSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_domeSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_domeSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_environmentOcclusionMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_environmentOcclusionMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_environmentOcclusionMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_environmentOcclusionMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_environmentOcclusionMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_environmentOcclusionMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_environmentOcclusionMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_environmentOcclusionMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_environmentOcclusionMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById(
      ...
      expect(
        (e = dataSource.entities.getById("sampled_customPatternSensor_environmentIntersectionColor_rgbaf"))
      ).toBeDefined();
      expect((e = dataSource.entities.getById("sampled_rectangularSensor_intersectionColor_rgbaf"))).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_lateralSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_lateralSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_lateralSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_lateralSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_lateralSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_lateralSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_lateralSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_lateralSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_lateralSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidHorizonSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidHorizonSurfaceMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidHorizonSurfaceMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidHorizonSurfaceMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidHorizonSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidHorizonSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidHorizonSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidHorizonSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_ellipsoidHorizonSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById(
      ...
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_domeSurfaceMaterial_solidColor_color"))
      ).toBeDefined();
      ...
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_domeSurfaceMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_domeSurfaceMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_domeSurfaceMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_domeSurfaceMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_domeSurfaceMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_domeSurfaceMaterial_checkerboard_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_domeSurfaceMaterial_checkerboard_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_environmentOcclusionMaterial_solidColor_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_environmentOcclusionMaterial_image"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_environmentOcclusionMaterial_grid"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_environmentOcclusionMaterial_stripe"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_environmentOcclusionMaterial_checkerboard"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_environmentOcclusionMaterial_image_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_environmentOcclusionMaterial_grid_color"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_environmentOcclusionMaterial_stripe_evenColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_environmentOcclusionMaterial_stripe_oddColor"))
      ).toBeDefined();
      expect(
        (e = dataSource.entities.getById(
      ...
      expect(
        (e = dataSource.entities.getById("sampled_rectangularSensor_environmentIntersectionColor_rgbaf"))
      ).toBeDefined();
      ...
      expect(e.properties.custom_boundingRectangle.getValue(documentStartDate)).toEqual(
        new BoundingRectangle(10924, 3626, 12558, 56113)
      );
      expect(e.properties.custom_boundingRectangle.getValue(documentStopDate)).toEqual(
        new BoundingRectangle(59127, 45286, 34992, 17032)
      );
      ...
      expect(e.properties.custom_cartographicRadians.getValue(documentStartDate)).toEqual(
        Cartesian3.fromRadians(1.25380297085855, 1.03510976346284, 7102)
      );
      expect(e.properties.custom_cartographicRadians.getValue(documentStopDate)).toEqual(
        Cartesian3.fromRadians(1.10648839763778, 0.231915563506949, 340)
      );
      expect(e.properties.custom_cartographicDegrees.getValue(documentStartDate)).toEqual(
        Cartesian3.fromDegrees(44, 31, 55762)
      );
      expect(e.properties.custom_cartographicDegrees.getValue(documentStopDate)).toEqual(
        Cartesian3.fromDegrees(10, 18, 28847)
      );
      ...
      expect(e.properties.custom_unitCartesian.getValue(documentStartDate)).toEqualEpsilon(
        new Cartesian3(0.0501133095086564, 0.917195967206924, 0.395272328843601),
        1e-14
      );
      expect(e.properties.custom_unitCartesian.getValue(documentStopDate)).toEqualEpsilon(
        new Cartesian3(0.797476048450763, 0.40584478979077, 0.446454878735849),
        1e-14
      );
      expect(e.properties.custom_spherical.getValue(documentStartDate)).toEqual(
        Cartesian3.fromSpherical(new Spherical(47098, 2231, 14088))
      );
      expect(e.properties.custom_spherical.getValue(documentStopDate)).toEqual(
        Cartesian3.fromSpherical(new Spherical(34883, 48264, 41148))
      );
      expect(e.properties.custom_unitSpherical.getValue(documentStartDate)).toEqualEpsilon(
        Cartesian3.fromSpherical(new Spherical(48811, 24254)),
        1e-14
      );
      expect(e.properties.custom_unitSpherical.getValue(documentStopDate)).toEqualEpsilon(
      ...
      expect(e.properties.custom_rgbaf.getValue(documentStartDate)).toEqualEpsilon(
        new Color(0.890196078431372, 0.450980392156863, 0.588235294117647, 0.72156862745098),
        1e-14
      );
      expect(e.properties.custom_rgbaf.getValue(documentStopDate)).toEqualEpsilon(
        new Color(0.419607843137255, 0.843137254901961, 0.36078431372549, 0.423529411764706),
        1e-14
      );
      ...
      expect(e.properties.custom_nearFarScalar.getValue(documentStartDate)).toEqual(
        new NearFarScalar(64112, 15354, 32827, 10368)
      );
      expect(e.properties.custom_nearFarScalar.getValue(documentStopDate)).toEqual(
        new NearFarScalar(55643, 45785, 33458, 29826)
      );
      expect(e.properties.custom_unitQuaternion.getValue(documentStartDate)).toEqualEpsilon(
        new Quaternion(0.697299305414108, 0.26496667122144, 0.615947719782462, 0.253327354041402),
        1e-14
      );
      expect(e.properties.custom_unitQuaternion.getValue(documentStopDate)).toEqualEpsilon(
        new Quaternion(0.134764165794432, 0.408681085292446, 0.902060273565587, 0.0332513608247514),
        1e-14
      );
      expect(e.properties.custom_wsen.getValue(documentStartDate)).toEqual(
        new Rectangle(1.4164143530628, 1.2888469381038, 0.679756561409663, 1.29649258884014)
      );
      expect(e.properties.custom_wsen.getValue(documentStopDate)).toEqual(
        new Rectangle(1.19133054275098, 0.9154648059314, 0.71347968461712, 1.32750822775441)
      );
      expect(e.properties.custom_wsenDegrees.getValue(documentStartDate)).toEqual(
        Rectangle.fromDegrees(29, 11, 17, 36)
      );
