  ...
  function () {
    ...
    it("A ModelGraphics causes a primitive to be created and updated.", function () {
      ...
      expect(primitive.modelMatrix).toEqual(
        Transforms.eastNorthUpToFixedFrame(Cartesian3.fromDegrees(1, 2, 3), scene.globe.ellipsoid)
      );
      ...
      expect(Cartesian3.equals(primitive.clippingPlanes._planes[0].normal, clippingPlanes._planes[0].normal)).toBe(
        true
      );
