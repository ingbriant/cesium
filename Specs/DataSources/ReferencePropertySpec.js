...
describe("DataSources/ReferenceProperty", function () {
  ...
  it("works with position properties", function () {
    ...
    expect(property.getValueInReferenceFrame(time, ReferenceFrame.INERTIAL)).toEqual(
      testObject.position.getValueInReferenceFrame(time, ReferenceFrame.INERTIAL)
    );
