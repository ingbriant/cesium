...
describe(
  ...
  function () {
    ...
    function createBasicPolylineVolume() {
      ...
      polylineVolume.positions = new ConstantProperty(Cartesian3.fromDegreesArray([0, 0, 1, 0, 1, 1, 0, 1]));
    ...
    it("dynamic updater sets properties", function () {
      var polylineVolume = new PolylineVolumeGraphics();
      polylineVolume.positions = createDynamicProperty(Cartesian3.fromRadiansArray([0, 0, 1, 0, 1, 1, 0, 1]));
