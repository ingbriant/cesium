          ...
          instance = new GeometryInstance({
            ...
            modelMatrix: Matrix4.multiplyByUniformScale(
              Matrix4.multiplyByTranslation(
                Transforms.eastNorthUpToFixedFrame(Cartesian3.fromDegrees(-90.0, 45.0)),
      ...
      function () {
        ...
        beforeAll(function () {
          instance = new GeometryInstance({
            ...
            modelMatrix: Matrix4.multiplyByTranslation(
              Transforms.eastNorthUpToFixedFrame(Cartesian3.fromDegrees(-100, 20)),
        ...
        beforeAll(function () {
          instance = new GeometryInstance({
            geometry: PolygonGeometry.fromPositions({
              vertexFormat: PerInstanceColorAppearance.FLAT_VERTEX_FORMAT,
              ellipsoid: ellipsoid,
              positions: Cartesian3.fromDegreesArray([0.0, 45.0, 10.0, 45.0, 10.0, 55.0, 0.0, 55.0]),
            }),
            id: "polygon",
            attributes: {
              color: new ColorGeometryInstanceAttribute(1.0, 1.0, 0.0, 1.0),
        ...
        it("hierarchy", function () {
          var hierarchy = new GeometryInstance({
            geometry: new PolygonGeometry({
              vertexFormat: PerInstanceColorAppearance.FLAT_VERTEX_FORMAT,
              polygonHierarchy: {
                positions: Cartesian3.fromDegreesArray([-109.0, 30.0, -95.0, 30.0, -95.0, 40.0, -109.0, 40.0]),
                holes: [
                  {
                    positions: Cartesian3.fromDegreesArray([-107.0, 31.0, -107.0, 39.0, -97.0, 39.0, -97.0, 31.0]),
                    holes: [
                      {
                        positions: Cartesian3.fromDegreesArray([-106.5, 31.5, -97.5, 31.5, -97.5, 38.5, -106.5, 38.5]),
                      },
                    ],
                  },
                ],
        ...
        beforeAll(function () {
          ...
          instance = new GeometryInstance({
            geometry: new WallGeometry({
              vertexFormat: PerInstanceColorAppearance.FLAT_VERTEX_FORMAT,
              ellipsoid: ellipsoid,
              positions: Cartesian3.fromDegreesArrayHeights([0.0, 0.0, height, 0.01, 0.0, height]),
            }),
            id: "wall",
            attributes: {
              color: new ColorGeometryInstanceAttribute(1.0, 1.0, 0.0, 1.0),
        ...
        function () {
          ...
          beforeAll(function () {
            instance = new GeometryInstance({
              ...
              modelMatrix: Matrix4.multiplyByTranslation(
                Transforms.eastNorthUpToFixedFrame(Cartesian3.fromDegrees(0, 0)),
