...
describe("Scene/ShadowVolumeAppearance", function () {
  ...
  function unpackLowLessThan100k(signedVec4Attribute) {
    ...
    return (
      (1000.0 * unsigned[0] + 10.0 * unsigned[1] + 0.1 * unsigned[2] + 0.001 * unsigned[3]) *
  ...
  function unpackHighMagLessThan100Million(signedVec4Attribute) {
    ...
    var unsigned = clampAndMagnitude(signedVec4Attribute);
    return (
      (1000000.0 * unsigned[0] + 10000.0 * unsigned[1] + 100.0 * unsigned[2] + unsigned[3]) *
      (signed[0] < 128.0 ? 1.0 : -1.0)
    );
  }
  ...
  function unpackLowLessThan1000k(signedVec4Attribute) {
    ...
    var unsigned = clampAndMagnitude(signedVec4Attribute);
    return (
      (10000.0 * unsigned[0] + 100.0 * unsigned[1] + unsigned[2] + 0.01 * unsigned[3]) *
      (signed[0] < 128.0 ? 1.0 : -1.0)
    );
  }
  ...
  it("checks for planar texture coordinate attributes", function () {
    ...
    expect(ShadowVolumeAppearance.hasAttributesForTextureCoordinatePlanes(smallRectangleAttributesBadFloats)).toBe(
      true
    );
    expect(ShadowVolumeAppearance.hasAttributesForTextureCoordinatePlanes(largeRectangleAttributesBadFloats)).toBe(
      false
    );
  });
