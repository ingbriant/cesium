  ...
  it("tessellates web mercator heightmaps", function () {
    ...
    for (var j = 0; j < height; ++j) {
      ...
      for (var i = 0; i < width; ++i) {
        ...
        var expectedU =
          (longitude - geographicSouthwest.longitude) / (geographicNortheast.longitude - geographicSouthwest.longitude);
        var expectedV =
          (latitude - geographicSouthwest.latitude) / (geographicNortheast.latitude - geographicSouthwest.latitude);
