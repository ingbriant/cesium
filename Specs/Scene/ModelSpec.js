  ...
  function () {
    ...
    it("renders with spherical harmonics", function () {
      ...
      return loadModel(boomBoxUrl).then(function (m) {
        ...
        var L00 = new Cartesian3(0.692622075009195, 0.4543516001819, 0.36910172299235); // L00, irradiance, pre-scaled base
        var L1_1 = new Cartesian3(0.289407068366422, 0.16789310162658, 0.106174907004792); // L1-1, irradiance, pre-scaled base
        var L10 = new Cartesian3(-0.591502034778913, -0.28152432317119, 0.124647554708491); // L10, irradiance, pre-scaled base
        var L11 = new Cartesian3(0.34945458117126, 0.163273486841657, -0.03095643545207); // L11, irradiance, pre-scaled base
        var L2_2 = new Cartesian3(0.22171176447426, 0.11771991868122, 0.031381053430064); // L2-2, irradiance, pre-scaled base
    ...
    it("Clipping planes union regions", function () {
      return loadModel(boxUrl).then(function (model) {
        ...
        model.clippingPlanes = new ClippingPlaneCollection({
          planes: [new ClippingPlane(Cartesian3.UNIT_Z, 5.0), new ClippingPlane(Cartesian3.UNIT_X, 0.0)],
