...
describe("Scene/Expression", function () {
  ...
  it("evaluates acos function", function () {
    ...
    expect(expression.evaluate(undefined)).toEqualEpsilon(
      new Cartesian4(0.0, CesiumMath.PI_OVER_TWO, 0.0, CesiumMath.PI_OVER_TWO, 0.0),
      CesiumMath.EPSILON7
    );
  });
  ...
  it("evaluates atan function", function () {
    ...
    expect(expression.evaluate(undefined)).toEqualEpsilon(
      new Cartesian3(0.0, CesiumMath.PI_OVER_FOUR, 0.0, CesiumMath.PI_OVER_FOUR),
      CesiumMath.EPSILON7
    );

    expression = new Expression("atan(vec4(0, 1, 0, 1))");
    expect(expression.evaluate(undefined)).toEqualEpsilon(
      new Cartesian4(0.0, CesiumMath.PI_OVER_FOUR, 0.0, CesiumMath.PI_OVER_FOUR, 0.0),
      CesiumMath.EPSILON7
    );
  });
  ...
  it("evaluates radians function", function () {
    ...
    expect(expression.evaluate(undefined)).toEqualEpsilon(
      new Cartesian4(Math.PI, CesiumMath.PI_OVER_TWO, Math.PI, CesiumMath.PI_OVER_TWO),
      CesiumMath.EPSILON7
    );
  });
  ...
  it("evaluates atan2 function", function () {
    ...
    expect(expression.evaluate(undefined)).toEqualEpsilon(new Cartesian2(0.0, 0.5 * Math.PI), CesiumMath.EPSILON10);
