...
describe("Scene/TileMapServiceImageryProvider", function () {
  ...
  it("supports the global-mercator profile with a non-flipped, mercator bounding box", function () {
    ...
    return pollToPromise(function () {
      ...
      var expectedSW = projection.unproject(new Cartesian2(-11877789.667642293, 1707163.7595205167));
      var expectedNE = projection.unproject(new Cartesian2(-4696205.4540757351, 7952627.0736533012));
