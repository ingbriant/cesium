  ...
  function () {
    ...
    it("getProperty and setProperty work for binary properties", function () {
      ...
      expect(batchTable.getProperty(1, "propertyMat4")).toEqual(
        new Matrix4(62, 66, 70, 74, 63, 67, 71, 75, 64, 68, 72, 76, 65, 69, 73, 77)
      ...
      batchTable.setProperty(
        1,
        "propertyMat4",
        new Matrix4(63, 67, 71, 75, 64, 68, 72, 76, 65, 69, 73, 77, 66, 70, 74, 78)
      );
    ...
    it("warns about deprecated batch hierarchy (pre-version 1.0)", function () {
      return checkBatchTableHierarchy(batchTableHierarchyLegacyUrl, false).then(function (tileset) {
