...
describe("Scene/computeFlyToLocationForRectangle", function () {
  ...
  function sampleTest(sceneMode) {
    ...
    return computeFlyToLocationForRectangle(rectangle, scene).then(function (result) {
      expect(result).toEqual(expectedResult);
      expect(computeFlyToLocationForRectangle._sampleTerrainMostDetailed).toHaveBeenCalledWith(
        terrainProvider,
        cartographics
      );
    });
