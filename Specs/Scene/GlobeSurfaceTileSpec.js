...
describe("Scene/GlobeSurfaceTile", function () {
  ...
  describe("processStateMachine", function () {
    ...
    it("loads available tiles", function () {
      mockTerrain.willBeAvailable(rootTile.southwestChild).requestTileGeometryWillSucceed(rootTile.southwestChild);
    ...
    it("marks an upsampled tile as such", function () {
      ...
      mockImagery.requestImageWillSucceed(rootTile).requestImageWillFail(rootTile.southwestChild);
    ...
    it("does not mark a tile as upsampled if it has fresh imagery", function () {
      ...
      mockImagery.requestImageWillSucceed(rootTile).requestImageWillSucceed(rootTile.southwestChild);
    ...
    it("uses undefined water mask texture for tiles that are entirely land", function () {
      mockTerrain.requestTileGeometryWillSucceed(rootTile).willHaveWaterMask(true, false, rootTile);
    ...
    it("creates water mask texture from multi-byte water mask data, if it exists", function () {
      mockTerrain.requestTileGeometryWillSucceed(rootTile).willHaveWaterMask(true, true, rootTile);
  ...
  describe("eligibleForUnloading", function () {
    ...
    it("returns false when RECEIVING", function () {
      ...
      mockTerrain.requestTileGeometryWillSucceed(rootTile).requestTileGeometryWillWaitOn(deferred.promise, rootTile);
