...
describe("Core/CorridorGeometry", function () {
  ...
  it("createGeometry returns undefined without 2 unique positions", function () {
    ...
    geometry = CorridorGeometry.createGeometry(
      new CorridorGeometry({
        positions: [
          new Cartesian3(-1349511.388149118, -5063973.22857992, 3623141.6372688496), //same lon/lat, different height
  ...
  it("computes right turn", function () {
    var m = CorridorGeometry.createGeometry(
      new CorridorGeometry({
        vertexFormat: VertexFormat.POSITION_ONLY,
        positions: Cartesian3.fromDegreesArray([90.0, -30.0, 90.0, -31.0, 91.0, -31.0]),
        cornerType: CornerType.MITERED,
        width: 30000,
      })
    );
  ...
  it("computes left turn", function () {
    var m = CorridorGeometry.createGeometry(
      new CorridorGeometry({
        vertexFormat: VertexFormat.POSITION_ONLY,
        positions: Cartesian3.fromDegreesArray([90.0, -30.0, 90.0, -31.0, 89.0, -31.0]),
        cornerType: CornerType.MITERED,
        width: 30000,
      })
    );
  ...
  it("computes with rounded corners", function () {
    var m = CorridorGeometry.createGeometry(
      new CorridorGeometry({
        ...
        positions: Cartesian3.fromDegreesArray([90.0, -30.0, 90.0, -31.0, 89.0, -31.0, 89.0, -32.0]),
  ...
  it("computeRectangle with result parameter", function () {
    var options = {
      positions: Cartesian3.fromDegreesArray([72.0, 0.0, 85.0, 15.0, 83.0, 20.0]),
      width: 5,
    };
    var geometry = new CorridorGeometry(options);
