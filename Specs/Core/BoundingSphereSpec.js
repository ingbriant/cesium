...
describe("Core/BoundingSphere", function () {
  ...
  it("fromRectangle2D", function () {
    ...
    var expected = new BoundingSphere(
      Cartesian3.ZERO,
      Math.sqrt(rectangle.east * rectangle.east + rectangle.north * rectangle.north)
    );
  ...
  it("union result parameter is a tight fit", function () {
    var bs1 = new BoundingSphere(
      Cartesian3.multiplyByScalar(Cartesian3.negate(Cartesian3.UNIT_X, new Cartesian3()), 3.0, new Cartesian3()),
      3.0
    );
    var bs2 = new BoundingSphere(Cartesian3.UNIT_X, 1.0);
    var expected = new BoundingSphere(
      Cartesian3.multiplyByScalar(Cartesian3.negate(Cartesian3.UNIT_X, new Cartesian3()), 2.0, new Cartesian3()),
      4.0
    );
  ...
  function expectBoundingSphereToContainPoint(boundingSphere, point, projection) {
    ...
    var distanceFromCenter = Cartesian3.magnitude(
      Cartesian3.subtract(pointInCartesian, boundingSphere.center, new Cartesian3())
    );
