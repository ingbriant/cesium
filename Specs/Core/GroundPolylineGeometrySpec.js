...
describe("Core/GroundPolylineGeometry", function () {
  ...
  it("miters turns", function () {
    var groundPolylineGeometry = new GroundPolylineGeometry({
      positions: Cartesian3.fromDegreesArray([0.01, 0.0, 0.02, 0.0, 0.02, 0.01]),
      granularity: 0.0,
    });
    ...
    expect(Cartesian3.equalsEpsilon(approximateExpectedMiterNormal, miteredStartNormal, CesiumMath.EPSILON2)).toBe(
      true
    );
  });
  ...
  it("breaks miters for tight turns", function () {
    var groundPolylineGeometry = new GroundPolylineGeometry({
      positions: Cartesian3.fromDegreesArray([0.01, 0.0, 0.02, 0.0, 0.01, CesiumMath.EPSILON7]),
      granularity: 0.0,
    });
    ...
    groundPolylineGeometry = new GroundPolylineGeometry({
      positions: Cartesian3.fromDegreesArray([0.01, 0.0, 0.02, 0.0, 0.015, CesiumMath.EPSILON7]),
      granularity: 0.0,
      loop: true,
    });
  ...
  it("interpolates long polyline segments", function () {
    ...
    groundPolylineGeometry = new GroundPolylineGeometry({
      positions: Cartesian3.fromDegreesArray([0.01, 0.0, 0.02, 0.0, 0.0201, 0.0]),
      granularity: 600.0,
    });
  ...
  it("loops when there are enough positions and loop is specified", function () {
    ...
    groundPolylineGeometry = new GroundPolylineGeometry({
      positions: Cartesian3.fromDegreesArray([0.01, 0.0, 0.02, 0.0, 0.02, 0.02]),
      granularity: 0.0,
      loop: true,
    });
  ...
  it("subdivides geometry across the IDL and Prime Meridian", function () {
    ...
    groundPolylineGeometry = new GroundPolylineGeometry({
      positions: Cartesian3.fromDegreesArray([179.0, 0.0, 179.0, 1.0, -179.0, 1.0, -179.0, 0.0]),
      granularity: 0.0, // no interpolative subdivision
      loop: true,
    });
