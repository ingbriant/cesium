...
describe("Core/PolylinePipeline", function () {
  it("wrapLongitude", function () {
    var positions = Cartesian3.fromDegreesArray([-75.163789, 39.952335, -80.2264393, 25.7889689]);
  ...
  it("wrapLongitude breaks polyline into segments with model matrix", function () {
    ...
    var positions = [new Cartesian3(0.0, 0.0, 0.0), new Cartesian3(0.0, 100000000.0, 0.0)];
