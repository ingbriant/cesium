...
describe("Core/CatmullRomSpline", function () {
  ...
  it("computes start and end tangents", function () {
    ...
    start = Cartesian3.multiplyByScalar(
      Cartesian3.subtract(
        Cartesian3.subtract(Cartesian3.multiplyByScalar(controlPoint1, 2.0, start), controlPoint2, start),
        controlPoint0,
        start
      ),
      0.5,
    ...
    var end = new Cartesian3();
      ...
      Cartesian3.add(
        Cartesian3.subtract(controlPointn0, Cartesian3.multiplyByScalar(controlPointn1, 2.0, end), end),
        controlPointn2,
        end
      ),
      0.5,
