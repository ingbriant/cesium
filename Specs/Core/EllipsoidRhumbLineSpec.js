...
describe("Core/EllipsoidRhumbLine", function () {
  ...
  it("finds midpoint and other points using intersection with longitude", function () {
    ...
    expect(
      Cartographic.equalsEpsilon(midpointUsingInterpolation, midpointUsingIntersection, CesiumMath.EPSILON12)
    ).toBe(true);
    ...
    expect(Cartographic.equalsEpsilon(pointUsingInterpolation, pointUsingIntersection, CesiumMath.EPSILON12)).toBe(
      true
    );
