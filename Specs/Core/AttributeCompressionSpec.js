...
describe("Core/AttributeCompression", function () {
  ...
  it("oct encoding high precision", function () {
    ...
    expect(AttributeCompression.octDecodeInRange(encoded.x, encoded.y, rangeMax, result)).toEqualEpsilon(
      normal,
      epsilon
    );
  ...
  it("octFloat encoding", function () {
    ...
    var result = new Cartesian3();
    var normal = new Cartesian3(0.0, 0.0, 1.0);
    expect(AttributeCompression.octDecodeFloat(AttributeCompression.octEncodeFloat(normal), result)).toEqualEpsilon(
      normal,
      epsilon
    );
  ...
  it("encode and packFloat is equivalent to oct encoding", function () {
    ...
    expect(AttributeCompression.octDecodeFloat(encodedFloat, new Cartesian3())).toEqual(
  ...
  it("pack is equivalent to oct encoding", function () {
    ...
    expect(decodedX).toEqual(
      AttributeCompression.octDecodeFloat(AttributeCompression.octEncodeFloat(x), new Cartesian3())
    );
    expect(decodedY).toEqual(
      AttributeCompression.octDecodeFloat(AttributeCompression.octEncodeFloat(y), new Cartesian3())
    );
    expect(decodedZ).toEqual(
      AttributeCompression.octDecodeFloat(AttributeCompression.octEncodeFloat(z), new Cartesian3())
    );
  });
